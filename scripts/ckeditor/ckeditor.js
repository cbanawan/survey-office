        ...
        window.CKEDITOR||(window.CKEDITOR=function(){
            var a={
                ...
                basePath:function(){
                    ...
                    if(!a)for(var c=document.getElementsByTagName("script"),b=0;b<c.length;b++){
            ...
            return function(c){
                ...
                if(1==b.length)if(document.addEventListener)document.addEventListener("DOMContentLoaded",a,!1),window.addEventListener("load",a,!1);
...
CKEDITOR.event||(CKEDITOR.event=function(){},CKEDITOR.event.implementOn=function(a){
    var b=CKEDITOR.event.prototype,c;
...
function(){
    ...
    c.prototype={
        getListenerIndex:function(a){
            for(var c=0,b=this.listeners;c<b.length;c++)if(b[c].fn==a)return c;return-1
            }
        };
...
return{
    ...
    on:function(c,b,i,f,e){
        ...
        if(k.getListenerIndex(b)<0){
            ...
            g.fn=b;
            g.priority=e;
            for(var l=k.length-1;l>=0;l--)if(k[l].priority<=e){
                k.splice(l+1,0,g);
                return{
                    removeListener:j
                }
...
fire:function(){
    ...
    return function(e,g,j){
        var k=b(this)[e],e=a,q=i;
        a=i=0;
        if(k){
            var l=k.listeners;
            if(l.length)for(var l=l.slice(0),n,o=0;o<l.length;o++){
                if(k.errorProof)try{
...
(function(){
    ...
    CKEDITOR.tools={
        arrayCompare:function(a,b){
            ...
            for(var d=0;d<a.length;d++)if(a[d]!=b[d])return false;return true
            },
        clone:function(a){
            var b;
            ...
            b=new a.constructor;
            for(d in a)b[d]=this.clone(a[d]);return b
            },
        capitalize:function(a){
            return a.charAt(0).toUpperCase()+a.substring(1).toLowerCase()
            },
        extend:function(a){
            var b=arguments.length,d,i;
            if(typeof(d=arguments[b-1])=="boolean")b--;
                ...
                for(var f=1;f<b;f++){
                var e=arguments[f],g;
                for(g in e)if(d===true||a[g]==void 0)if(!i||g in i)a[g]=e[g]
                    }
                    return a
            },
        ...
        isEmpty:function(a){
            for(var b in a)if(a.hasOwnProperty(b))return false;return true
            },
    ...
    buildStyleHtml:function(a){
        for(var a=[].concat(a),b,d=[],i=0;i<a.length;i++)if(b=a[i])/@import|[{}]/.test(b)?d.push("<style>"+b+"</style>"):d.push('<link type="text/css" rel=stylesheet href="'+b+'">');return d.join("")
        },
...
indexOf:function(a,b){
    if(typeof b=="function")for(var d=0,i=a.length;d<i;d++){
        if(b(a[d]))return d
            }else{
        if(a.indexOf)return a.indexOf(b);
        d=0;
        for(i=a.length;d<i;d++)if(a[d]===b)return d
            }
            return-1
    },
search:function(a,b){
...
createClass:function(a){
    var b=a.$,d=a.base,i=a.privates||a._,f=a.proto,a=a.statics;
    !b&&(b=function(){
        d&&this.base.apply(this,arguments)
        });
    if(i)var e=b,b=function(){
        var a=this._||(this._={}),j;
        for(j in i){
            var b=i[j];
...
normalizeCssText:function(a,b){
    var d=[],i,f=CKEDITOR.tools.parseCssText(a,true,b);
    for(i in f)d.push(i+":"+f[i]);d.sort();
...
return{
    ...
    removeListener:function(a){
        ...
        if(!this.hasListeners(a)){
            var c=this.getCustomData("_cke_nativeListeners"),h=c&&c[a];
            if(h){
...
removeAllListeners:function(){
    var a=this.getCustomData("_cke_nativeListeners"),c;
    for(c in a){
        var h=a[c];
...
a.removeCustomData=function(a){
    var h=this.$["data-cke-expando"],h=h&&b[h],d,i;
    if(h){
        d=h[a];
        i=a in h;
        delete h[a]
...
getIndex:function(a){
    ...
    do if(!a||!(b!=this.$&&b.nodeType==CKEDITOR.NODE_TEXT&&(h||!b.nodeValue))){
        c++;
...
getNextSourceNode:function(a,b,c){
    if(c&&!c.call)var h=c,c=function(a){
        return!a.equals(h)
        };
...
getCommonAncestor:function(a){
    ...
    do if(b.contains(a))return b;while(b=
        b.getParent());
    return null
    },
getPosition:function(a){
    ...
    if(this.type==CKEDITOR.NODE_ELEMENT&&a.type==CKEDITOR.NODE_ELEMENT){
        if(b.contains){
            ...
            for(var b=this.getAddress(),a=a.getAddress(),c=Math.min(b.length,a.length),h=0;h<=c-1;h++)if(b[h]!=a[h]){
...
CKEDITOR.tools.extend(CKEDITOR.dom.window.prototype,{
    ...
    getViewPaneSize:function(){
        var a=this.$.document,b=a.compatMode=="CSS1Compat";
        return{
...
CKEDITOR.dom.element.setMarker=function(a,b,c,h){
    var d=b.getCustomData("list_marker_id")||b.setCustomData("list_marker_id",CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"),i=b.getCustomData("list_marker_names")||b.setCustomData("list_marker_names",{}).getCustomData("list_marker_names");
    a[d]=b;
    i[c]=1;
...
CKEDITOR.dom.element.clearMarkers=function(a,b,c){
    var h=b.getCustomData("list_marker_names"),d=b.getCustomData("list_marker_id"),i;
    for(i in h)b.removeCustomData(i);b.removeCustomData("list_marker_names");
    if(c){
...
getAttribute:function(){
    ...
    return CKEDITOR.env.ie&&(CKEDITOR.env.ie7Compat||CKEDITOR.env.ie6Compat)?function(a){
        switch(a){
            ...
            case "hspace":case "value":
                return this.$[a];
            case "style":
                return this.$.style.cssText;
            case "contenteditable":case "contentEditable":
...
hasAttributes:CKEDITOR.env.ie&&(CKEDITOR.env.ie7Compat||CKEDITOR.env.ie6Compat)?function(){
    for(var a=this.$.attributes,b=0;b<a.length;b++){
        ...
        switch(c.nodeName){
            case "class":
                if(this.getAttribute("class"))return true;case "data-cke-expando":
                continue;
            default:
...
moveChildren:function(a,b){
    ...
    if(c!=a){
        var h;
        if(b)for(;h=c.lastChild;)a.insertBefore(c.removeChild(h),
            a.firstChild);else for(;h=c.firstChild;)a.appendChild(c.removeChild(h))
            }
        },
...
setAttributes:function(a){
    for(var b in a)this.setAttribute(b,a[b]);return this
    },
setValue:function(a){
    this.$.value=a;
    return this
...
setStyles:function(a){
    for(var b in a)this.setStyle(b,a[b]);return this
    },
...
getDocumentPosition:function(a){
    var b=0,c=0,h=this.getDocument(),d=h.getBody(),i=h.$.compatMode=="BackCompat";
    if(document.documentElement.getBoundingClientRect){
        var f=this.$.getBoundingClientRect(),e=h.$.documentElement,g=e.clientTop||
        d.$.clientTop||0,j=e.clientLeft||d.$.clientLeft||0,k=true;
        if(CKEDITOR.env.ie){
...
i=a.getWindow();
d=g(this,i);
var q=g(a,i),l=this.$.offsetHeight;
h=this.$.offsetWidth;
...
copyAttributes:function(a,b){
    for(var c=this.$.attributes,b=b||{},h=0;h<c.length;h++){
        var d=c[h],i=d.nodeName.toLowerCase(),f;
        if(!(i in b))if(i=="checked"&&(f=this.getAttribute(i)))a.setAttribute(i,f);
...
renameNode:function(a){
    if(this.getName()!=a){
        var b=
        this.getDocument(),a=new CKEDITOR.dom.element(a,b);
...
(function(){
    function a(a,b){
        ...
        j=c.endContainer;
        var h=c.startOffset,d=c.endOffset,i,o=this.guard,m=this.type,p=a?"getPreviousSourceNode":"getNextSourceNode";
        if(!a&&!this._.guardLTR){
            var s=j.type==CKEDITOR.NODE_ELEMENT?j:j.getParent(),r=j.type==CKEDITOR.NODE_ELEMENT?j.getChild(d):j.getNext();
        ...
        k:k.getParent(),u=k.type==CKEDITOR.NODE_ELEMENT?h?k.getChild(h-1):null:k.getPrevious();
...
var h=/^[\t\r\n ]*(?:&nbsp;|\xa0)$/,d=CKEDITOR.dom.walker.whitespaces(),i=CKEDITOR.dom.walker.bookmark();
...
(function(){
    function a(a){
        var b=false,c=CKEDITOR.dom.walker.bookmark(true),
        e=/^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        return function(g){
            if(c(g))return true;
            if(g.type==CKEDITOR.NODE_TEXT)if(CKEDITOR.env.ie&&e.test(g.getText())&&!b&&(!a||!g.getNext()))b=true;
                else{
                if(g.hasAscendant("pre")||CKEDITOR.tools.trim(g.getText()).length)return false
                    }else if(g.type==CKEDITOR.NODE_ELEMENT&&!i[g.getName()])if(!CKEDITOR.env.ie&&g.is("br")&&!b&&(!a||!g.getNext()))b=true;else return false;
            return true
            }
        }
    function b(a){
...
function c(a){
    ...
    a.optimizeBookmark();
    var g=a.startContainer,f=a.endContainer,h=a.startOffset,d=a.endOffset,i,r;
    if(f.type==CKEDITOR.NODE_TEXT)f=f.split(d);
    else if(f.getChildCount()>0)if(d>=f.getChildCount()){
    ...
    if(g.type==CKEDITOR.NODE_TEXT){
        ...
        }else if(h)if(h>=g.getChildCount()){
        ...
        var h=g.getParents(),d=f.getParents(),t,u,v;
    ...
    for(c=t;c<d.length;c++){
        ...
        if(!h[c]||x.$.parentNode!=h[c].$.parentNode)for(x=x.getPrevious();x;){
...
r&&f.$.parentNode&&f.remove()
    ...
    u:1,
    "var":1
},f=CKEDITOR.dom.walker.bogus(),e=new CKEDITOR.dom.walker.whitespaces,g=new CKEDITOR.dom.walker.bookmark;
...
createBookmark2:function(a){
    var b=this.startContainer,c=this.endContainer,e=this.startOffset,g=this.endOffset,f=this.collapsed,h,d;
    if(!b||!c)return{
        start:0,
        end:0
    };
...
trim:function(a,b){
    ...
    e=this.startOffset,g=this.collapsed;
    if((!a||g)&&c&&c.type==CKEDITOR.NODE_TEXT){
        if(e)if(e>=c.getLength()){
            e=c.getIndex()+1;
            c=c.getParent()
            }else{
            var f=c.split(e),e=c.getIndex()+1,c=c.getParent();
...
enlarge:function(a,b){
    switch(a){
        ...
        case CKEDITOR.ENLARGE_ELEMENT:
            ...
            var e=this.getCommonAncestor(),g=this.root,f,h,d,i,r,t=false,u,v;
            ...
            if(d&&!i){
                ...
                if(i.type==CKEDITOR.NODE_COMMENT)i=i.getPrevious();
                    ...
                    if(i.type==CKEDITOR.NODE_TEXT){
                        ...
                        /[^\s\ufeff]/.test(v)&&(i=null);
                        u=/[\s\ufeff]$/.test(v)
                        }else if((i.$.offsetWidth>0||b&&i.is("br"))&&!i.data("cke-bookmark"))if(t&&CKEDITOR.dtd.$removeEmpty[i.getName()]){
                        v=
                        i.getText();
                        if(/[^\s\ufeff]/.test(v))i=null;else for(var w=i.$.getElementsByTagName("*"),x=0,y;y=w[x++];)if(!CKEDITOR.dtd.$removeEmpty[y.nodeName.toLowerCase()]){
                            i=null;
                            break
                        }
                        i&&(u=!!v.length)
                ...
                if(i.type==CKEDITOR.NODE_TEXT){
                    ...
                    if((i.$.offsetWidth>0||b&&i.is("br"))&&!i.data("cke-bookmark"))if(t&&CKEDITOR.dtd.$removeEmpty[i.getName()]){
                        ...
                        if(/[^\s\ufeff]/.test(v))i=null;
                            ...
                            for(x=0;y=w[x++];)if(!CKEDITOR.dtd.$removeEmpty[y.nodeName.toLowerCase()]){
                                i=null;
                                break
                            }
                            }
        ...
        break;
case CKEDITOR.ENLARGE_BLOCK_CONTENTS:case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
...
shrink:function(a,b,c){
    if(!this.collapsed){
        var a=a||CKEDITOR.SHRINK_TEXT,e=this.clone(),g=this.startContainer,f=this.endContainer,h=this.startOffset,d=this.endOffset,i=1,r=1;
        if(g&&g.type==CKEDITOR.NODE_TEXT)if(h)if(h>=g.getLength())e.setStartAfter(g);
            else{
            e.setStartBefore(g);
            i=0
            }else e.setStartBefore(g);
        if(f&&f.type==CKEDITOR.NODE_TEXT)if(d)if(d>=f.getLength())e.setEndAfter(f);
            else{
            e.setEndAfter(f);
            r=0
            }else e.setEndBefore(f);
        var e=new CKEDITOR.dom.walker(e),t=CKEDITOR.dom.walker.bookmark();
...
splitBlock:function(a){
    var b=
    new CKEDITOR.dom.elementPath(this.startContainer,this.root),c=new CKEDITOR.dom.elementPath(this.endContainer,this.root),e=b.block,g=c.block,f=null;
...
checkBoundaryOfElement:function(a,c){
    var e=c==CKEDITOR.START,g=this.clone();
    g.collapse(e);
...
getEnclosedNode:function(){
    ...
    var b=new CKEDITOR.dom.walker(a),c=CKEDITOR.dom.walker.bookmark(true),e=CKEDITOR.dom.walker.whitespaces(true);
    a.evaluator=
    function(a){
        return e(a)&&c(a)
        };
...
scrollIntoView:function(){
    var a=new CKEDITOR.dom.element.createFromHtml("<span>​</span>",this.document),b,c,e,g=this.clone();
    g.optimize();
...
(function(){
    ...
    var c=/^[\r\n\t ]+$/,h=CKEDITOR.dom.walker.bookmark(false,true),d=CKEDITOR.dom.walker.whitespaces(true),i=function(a){
    return h(a)&&d(a)
    };
...
a.prototype={
    ...
    for(this._.nextNode=null;n;){
        var o=0,m=n.hasAscendant("pre"),p=n.type!=CKEDITOR.NODE_ELEMENT,s=0;
...
add:function(a,b){
    ...
    if(!c||c!=this){
        c&&c.remove(a);
        var c="focus",h="blur";
        if(b)if(CKEDITOR.env.ie&&CKEDITOR.env.version<9){
            c="focusin";
            h="focusout"
...
(function(){
    var a,b=function(b){
        var b=b.data,c=b.getKeystroke(),i=this.keystrokes[c],f=this._.editor;
        a=f.fire("key",{
            keyCode:c
        })===false;
        if(!a){
...
(function(){
    CKEDITOR.lang={
        ...
        detect:function(a,b){
            var c=this.languages,b=b||navigator.userLanguage||navigator.language||a,h=b.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/),d=h[1],h=h[2];
...
CKEDITOR.scriptLoader=function(){
    ...
    return{
        load:function(c,h,d,i){
            ...
            d||(d=
                CKEDITOR);
            var e=c.length,g=[],j=[],k=function(a){
            ...
            if(e===0)k(true);
                ...
                if(a[c])q(c,true);
                    ...
                    if(!(e.length>1)){
                        ...
                        if(h)if(CKEDITOR.env.ie)g.$.onreadystatechange=
                            function(){
...
load:function(a,b,c){
    ...
    for(var h=this.loaded,d=this.registered,i=[],f={},e={},g=0;g<a.length;g++){
        ...
        for(var j=0;j<a.length;j++)for(var d=f[a[j]],k=0;k<d.length;k++){
            var i=d[k];
            e[i]=this.get(i);
            h[i]=1
            }
    ...
    return function(c,h,d){
        var i={},f=function(c){
            a.call(this,c,function(a){
                ...
                var c=[],e;
                for(e in a){
                    var q=a[e],l=q&&q.requires;
                    if(!b[e]){
                        if(q.icons)for(var n=
...
CKEDITOR.plugins.setLang=function(a,b,c){
    var h=this.get(a),a=h.langEntries||(h.langEntries={}),h=h.lang||(h.lang=[]);
    h.split&&(h=h.split(","));
...
CKEDITOR.ui.prototype={
    ...
    create:function(a){
        var b=this.items[a],c=b&&this._.handlers[b.type],h=b&&b.command&&this.editor.getCommand(b.command),
...
(function(){
    function a(a,e,g){
        ...
        function h(a){
    var b=this.commands,c=a.editor,e=a.data.path,g;
    for(g in b){
        a=b[g];
    ...
    a.on("customConfigLoaded",function(){
        if(b){
            if(b.on)for(var c in b.on)a.on(c,b.on[c]);CKEDITOR.tools.extend(a.config,b,true);
            delete a.config.on
            }
...
function f(a){
    ...
    function g(a){
    var b=a.config,c=b.plugins,
    e=b.extraPlugins,g=b.removePlugins;
    if(e)var f=RegExp("(?:^|,)(?:"+e.replace(/\s*,\s*/g,"|")+")(?=,|$)","g"),c=c.replace(f,""),c=c+(","+e);
    if(g){
    ...
    CKEDITOR.plugins.load(c.split(","),function(c){
        ...
        for(var c=["beforeInit","init","afterInit"],f=0;f<c.length;f++)for(var j=0;j<e.length;j++){
            var d=e[j];
...
setKeystroke:function(){
    for(var a=
        this.keystrokeHandler.keystrokes,b=CKEDITOR.tools.isArray(arguments[0])?arguments[0]:[[].slice.call(arguments,0)],c,e,g=b.length;g--;){
        c=b[g];
        e=0;
...
(function(){
    function a(a){
        ...
        ol:1,
        dl:1
    },CKEDITOR.dtd.table,CKEDITOR.dtd.ul,CKEDITOR.dtd.ol,CKEDITOR.dtd.dl),c=CKEDITOR.env.ie&&CKEDITOR.env.version<8?{
        dd:1,
        dt:1
    }:{},h={
        ol:1,
    ...
    CKEDITOR.htmlParser.fragment.fromHtml=function(i,f,e){
        function g(a){
            ...
            if(n.length>0)for(var c=0;c<n.length;c++){
                var e=n[c],g=e.name,f=CKEDITOR.dtd[g],
...
var q=new CKEDITOR.htmlParser,l=f instanceof CKEDITOR.htmlParser.element?f:typeof f=="string"?new CKEDITOR.htmlParser.element(f):new CKEDITOR.htmlParser.fragment,
n=[],o=[],m=l,p=l.name=="textarea",s=l.name=="pre";
    ...
    if(a(f))n.push(f);
        ...
        if(e=="pre")s=true;
            ...
            for(;;){
                ...
                if(!f.isUnknown&&!m.isUnknown&&!l[e])if(m.isOptionalClose)q.onTagClose(i);
...
q.onTagClose=function(a){
    for(var b=n.length-1;b>=0;b--)if(a==
        n[b].name){
        n.splice(b,1);
        return
    }
...
q.onText=function(a){
    ...
    var c=m.name,f=c?CKEDITOR.dtd[c]||(m._.isBlockLike?CKEDITOR.dtd.div:CKEDITOR.dtd.span):d;
    if(!p&&
        !f["#"]&&c in b){
...
(function(){
    function a(a,
        b){
        for(var c=0;a&&c<b.length;c++)var g=b[c],a=a.replace(g[0],g[1]);
        return a
        }
        function b(a,b,c){
...
proto:{
    ...
    onElement:function(a){
        for(var b=[this._.elements["^"],this._.elements[a.name],this._.elements.$],c,g=0;g<3;g++)if(c=b[g]){
            c=c.filter(a,this);
...
b.root=h(true,false);
for(r in s)b.elements[r]=h(true,a.config.fillEmptyBlocks);c.addRules(b)
};
...
CKEDITOR.htmlDataProcessor.prototype={
    toHtml:function(b,c,
        ...
        if(typeof c!="string"){
            ...
            var b=l(b,this.editor),b=f(b),b=e(b),b=b.replace(D,"$1cke:$2"),b=b.replace(B,"<cke:$1$2></cke:$1>"),b=b.replace(/(<pre\b[^>]*>)(\r\n|\n)/g,"$1$2$2"),h=this.editor.editable(),i,h=c=c||h.getName();
    ...
    toDataFormat:function(b){
        var c=this.editor.editable(),e=this.writer,b=CKEDITOR.htmlParser.fragment.fromHtml(b,c.getName(),a(this.editor.config));
        e.reset();
...
var n=/^[\t\r\n ]*(?:&nbsp;|\xa0)$/,o="{cke_protected}",
m=CKEDITOR.dtd,p=["caption","colgroup","col","thead","tfoot","tbody"],s=CKEDITOR.tools.extend({},m.$block,m.$listItem,m.$tableContent),r;
for(r in s)"br"in m[r]||delete s[r];delete s.pre;
var t={
    elements:{},
...
for(r in s)u.elements[r]=h();var v={
    elementNames:[[/^cke:/,""],[/^\?xml:namespace$/,""]],
    attributeNames:[[/^data-cke-(saved|pa)-/,""],[/^data-cke-.*/,""],["hidefocus",""]],
    elements:{$:function(a){var b=a.attributes;if(b){if(b["data-cke-temp"])return false;
...
for(r in{
    ...
    var w=/<(a|area|img|input)\b([^>]*)>/gi,x=/\b(on\w+|href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi,
y=/(?:<style(?=[ >])[^>]*>[\s\S]*<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,z=/<cke:encoded>([^<]*)<\/cke:encoded>/gi,D=/(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,J=/(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi,B=/<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
})();
...
CKEDITOR.htmlParser.cssStyle=function(a){
    ...
    return{
        ...
        toString:function(){
            var a=[],h;
            for(h in b)b[h]&&a.push(h,":",b[h],";");return a.join("")
            }
        }
};
(function(){
    ...
    CKEDITOR.htmlParser.element.prototype={
        ...
        writeHtml:function(b,c){
            var h=this.attributes,d=this,i=d.name,f,e,g,j;
        ...
        b.openTag(i,h);
    for(var k=[],q=0;q<2;q++)for(f in h){
        e=f;
        g=h[f];
        if(q==1)k.push([f,g]);
        else if(c){
            for(;;)if(e=c.onAttributeName(f))if(e!=f){
                delete h[f];
                f=e
                }else break;
                else{
...
(function(){
    ...
    CKEDITOR.inlineAll=function(){
        var a,b,c;
        for(c in CKEDITOR.dtd.$editable)for(var h=CKEDITOR.document.getElementsByTag(c),d=0,i=h.count();d<i;d++){
            a=h.getItem(d);
...
(function(){
    ...
    function c(a){
    var b=a.name,c=a.element,g=a.elementMode,j=a.fire("uiSpace",{
        space:"top",
        html:""
    }).html,h=a.fireOnce("uiSpace",{
        space:"bottom",
        html:""
    }).html,q=a.config.height;
    isNaN(q)||(q=
        q+"px");
    var l="",n=a.config.width;
...
CKEDITOR.editor.prototype.resize=function(a,b,c,g){
    var j=this.container,d=this.ui.space("contents"),h=CKEDITOR.env.webkit&&this.document&&this.document.getWindow().$.frameElement,g=g?j.getChild(1):j;
...
(function(){
    ...
    function c(a,b){
    return function(c){
        var f=c.data.getTarget(),d=c.data.$.toElement||c.data.$.fromElement||c.data.$.relatedTarget,d=d?CKEDITOR.dom.element.get(d):null;
        f.equals(b)&&(!d||
...
insertText:function(a){
    ...
    if(!b){
        var h=/\n{2}/g;
        if(h.test(a))var i="<"+c+">",n="</"+c+">",a=i+a.replace(h,function(){
            return n+
            i
            })+n
        }
...
insertElement:function(a){
    ...
    for(var c=this.editor,j=c.config.enterMode,f=c.getSelection(),d=f.getRanges(),h=a.getName(),i=CKEDITOR.dtd.$block[h],o,m,p,s=d.length-1;s>=0;s--){
        ...
        if(!o.checkReadOnly()){
            ...
            m=!s&&a||a.clone(1);
            var r,t;
            if(i)for(;(r=o.getCommonAncestor(0,1))&&(t=CKEDITOR.dtd[r.getName()])&&(!t||!t[h]);)if(r.getName()in CKEDITOR.dtd.span)o.splitElement(r);
                else if(o.checkStartOfBlock()&&o.checkEndOfBlock()){
                o.setStartBefore(r);
                o.collapse(true);
                r.remove()
                }else o.splitBlock(j==CKEDITOR.ENTER_DIV?"div":"p",c.editable());o.insertNode(m);
            p||(p=m)
            }
        }
    if(p){
    o.moveToPosition(p,CKEDITOR.POSITION_AFTER_END);
    if(i)if((a=p.getNext(b))&&a.type==CKEDITOR.NODE_ELEMENT&&a.is(CKEDITOR.dtd.$block))a.getDtd()["#"]?o.moveToElementEditStart(a):
    ...
    if(this.equals(CKEDITOR.document.getActive())){
        ...
        this.attachListener(this,"keydown",function(a){
            ...
            if(c in{
                ...
                var g=b.getSelection(),j=g.getSelectedElement(),g=g.getRanges()[0],f=g.startPath(),h,k,i,c=c==8;
                if(j){
                    b.fire("saveSnapshot");
                    ...
                    }else if(g.collapsed)if((h=f.block)&&
...
var h=/(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,d=CKEDITOR.dom.walker.whitespaces(true),i=CKEDITOR.dom.walker.bookmark(false,true);
    ...
    c.on("selectionChange",function(a){
        if(!c.readOnly){
            ...
            if(e&&!e.isLocked){
                ...
                var f=a.editor,i=f.editable(),n=a.data.path,o=n.blockLimit,
                m=a.data.selection.getRanges()[0],p=f.config.enterMode,s=0;
                if(CKEDITOR.env.gecko){
                    var r=n.block||n.blockLimit||n.root,t=r&&r.getLast(b);
                ...
                if(CKEDITOR.env.ie)if((i=f.getFirst(b))&&i.type==CKEDITOR.NODE_TEXT&&
                    CKEDITOR.tools.trim(i.getText()).match(/^(?:&nbsp;|\xa0)$/)){
                    i.remove();
                    s=1
                    }
                    if(f.getOuterHtml().match(h))if((i=f.getNext(d))&&i.type==CKEDITOR.NODE_ELEMENT&&(!i.isBlockBoundary()||!CKEDITOR.dtd.$empty[i.getName()])){
...
function(){
    function a(b,c){
        function g(){
            ...
            var e=/<(ol|ul|dl)\b/i.test(c),f=b.range.startPath();
    ...
    function d(a,b){
        var c=[],g=a.getChildren(),e=g.count(),h,i=0,q=o[b],n=!a.is(o.$inline)||a.is("br");
        for(n&&c.push(" ");i<e;i++){
            h=g.getItem(i);
    ...
    var g=b.endContainer.getChild(b.endOffset),e=b.endContainer.getChild(b.endOffset-1);
g&&c(g,a[a.length-1]);
if(e&&c(e,a[0])){
...
return function(m,t,u){
    ...
    if(!w.checkReadOnly()){
        var x=(new CKEDITOR.dom.elementPath(w.startContainer,w.root)).blockLimit||w.root,t={
            type:t,
            editable:m,
            editor:v,
            range:w,
        ...
        if(!a(t,u)){
            var v=t.range,x=t.mergeCandidates,y,z,D,J,B;
            ...
            if(!v.collapsed){
                ...
                for(;(B=f(v.startContainer)&&v.startContainer.getChild(v.startOffset-1))&&f(B)&&B.isBlockBoundary()&&D.contains(B);)v.moveToPosition(B,
            ...
            for(y=z.startNode;(y=y.getParent())&&h(y);)x.push(y);
            v.moveToBookmark(z);
            if(u){
                B=u;
                z=t.range;
...
for(O=K.createBookmark();L=t.zombies.pop();)if(L.getParent()){
    I=K.clone();
...
function h(a){
    ...
    if(c){
        if(b!==false){
            var g,e=a.getDocument().getSelection().getNative(),f=e&&e.type!="None"&&e.getRangeAt(0);
            if(c.getLength()>
...
CKEDITOR.on("instanceCreated",
    function(c){
        ...
        e.on("contentDom",function(){
            var c=e.document,g=e.editable(),f=c.getBody(),d=c.getDocumentElement(),j=g.isInline();
    ...
    if(CKEDITOR.env.webkit)c.on("keydown",function(a){
        switch(a.data.getKey()){
            case 13:case 33:case 34:case 35:case 36:case 37:case 39:case 8:case 45:case 46:
                i(e.document)
                }
            },null,null,10)
    });
    ...
    getRanges:function(){
        ...
        function(){
            function a(b){
                ...
                b=b.duplicate();
                b.collapse(c);
                var g=b.parentElement(),e=g.ownerDocument;
...
return function(){
    var a=this.getNative(),c=a&&a.createRange(),g=this.getType();
    if(!a)return[];
...
return function(b){
    ...
    if(b)for(var g=c.ranges,e=0;e<g.length;e++){
        var f=
        g[e];
        f.getCommonAncestor().isReadOnly()&&g.splice(e,1);
        if(!f.collapsed){
            if(f.startContainer.isReadOnly())for(b=f.startContainer;b;){
                if(b.is("body")||!b.isReadOnly())break;
                b.type==CKEDITOR.NODE_ELEMENT&&b.getAttribute("contentEditable")=="false"&&f.setStartAfter(b);
                b=b.getParent()
                }
                var b=f.startContainer,d=f.endContainer,h=f.startOffset,i=f.endOffset,r=f.clone();
...
getSelectedElement:function(){
    ...
    var b=this,c=CKEDITOR.tools.tryThese(function(){
        ...
        var a,c,g=b.getRanges()[0],e=g.getCommonAncestor(1,1),f={
            table:1,
            ul:1,
            ol:1,
            dl:1
        },d;
        for(d in f)if(a=e.getAscendant(d,1))break;if(a){
            e=new CKEDITOR.dom.range(b.root);
            e.setStartAt(a,CKEDITOR.POSITION_AFTER_START);
            e.setEnd(g.startContainer,g.startOffset);
            var h=CKEDITOR.tools.extend(f,CKEDITOR.dtd.$listItem,CKEDITOR.dtd.$tableContent),f=new CKEDITOR.dom.walker(e);
            d=function(a,b){
                return function(c,g){
...
getSelectedText:function(){
    ...
    var b=this.getNative(),b=CKEDITOR.env.ie?b.type=="Control"?"":b.createRange().text:b.toString();
...
selectRanges:function(a){
    if(a.length)if(this.isLocked){
        ...
        if(CKEDITOR.env.ie){
            var c=CKEDITOR.dom.walker.whitespaces(true),e=/\ufeff|\u00a0/,f={
                table:1,
                tbody:1,
                tr:1
            };
    ...
    if(!c){
        ...
        this.on("selectionChange",function(a){
            for(var b=0;b<c.length;b++){
                var i=c[b],f=i.style.checkActive(a.data.path)?CKEDITOR.TRISTATE_ON:CKEDITOR.TRISTATE_OFF;
                i.fn.call(this,f)
                }
            })
    }
...
(function(){
    ...
    if(b.collapsed){
        ...
        var g=this.element,e=this._.definition,f,d=e.ignoreReadonly,h=d||e.includeReadonly;
        ...
        b.trim();
        var i=b.createBookmark(),k=i.startNode,q=i.endNode,n=k,o;
        if(!d){
            var p=
            b.getCommonAncestor(),d=a(k,p),p=a(q,p);
            ...
            if(n.equals(q)){
                ...
                var u=n.type,s=u==CKEDITOR.NODE_ELEMENT?n.getName():null,p=s&&n.getAttribute("contentEditable")=="false",r=s&&n.getAttribute("data-nostyle");
                ...
                if(!s||j[s]&&!r&&(!p||h)&&(n.getPosition(q)|CKEDITOR.POSITION_PRECEDING|CKEDITOR.POSITION_IDENTICAL|CKEDITOR.POSITION_IS_CONTAINED)==
                    ...
                    if(x&&((x.getDtd()||CKEDITOR.dtd.span)[g]||f)&&(!e.parentRule||e.parentRule(x))){
                        if(!o&&(!s||!CKEDITOR.dtd.$removeEmpty[s]||(n.getPosition(q)|CKEDITOR.POSITION_PRECEDING|CKEDITOR.POSITION_IDENTICAL|CKEDITOR.POSITION_IS_CONTAINED)==CKEDITOR.POSITION_PRECEDING+CKEDITOR.POSITION_IDENTICAL+CKEDITOR.POSITION_IS_CONTAINED)){
                            ...
                            for(var u=n,t;(d=!u.getNext(z))&&(t=u.getParent(),j[t.getName()])&&(t.getPosition(k)|CKEDITOR.POSITION_FOLLOWING|CKEDITOR.POSITION_IDENTICAL|CKEDITOR.POSITION_IS_CONTAINED)==CKEDITOR.POSITION_FOLLOWING+CKEDITOR.POSITION_IDENTICAL+CKEDITOR.POSITION_IS_CONTAINED&&(!e.childRule||e.childRule(t));)u=t;
                            o.setEndAfter(u)
                            }
                        }else d=true
                    }else d=true;
            ...
            for(var d=m(this,c),p=d.hasAttributes(),r=o.getCommonAncestor(),
                u={},s={},x={},v={},w,y,D;d&&r;){
                if(r.getName()==g){
                    for(w in e.attributes)if(!v[w]&&(D=r.getAttribute(y)))d.getAttribute(w)==D?s[w]=1:v[w]=1;for(y in e.styles)if(!x[y]&&(D=r.getStyle(y)))d.getStyle(y)==D?u[y]=1:x[y]=1
                        }
                        r=r.getParent()
                }
                for(w in s)d.removeAttribute(w);for(y in u)d.removeStyle(y);p&&!d.hasAttributes()&&(d=null);
            if(d){
...
function c(a){
    ...
    for(f=0;;f++){
        h=g.elements[f];
        if(h.equals(e))break;
        else if(h.match)continue;else h=h.clone();
        h.append(d);
        d=h
        }
    ...
    var j=b.endNode,i=this,g=function(){
...
function h(a){
    ...
    if(a=(new CKEDITOR.dom.elementPath(b,a.root)).contains(this.element,1)){
        ...
        if(c)for(var g in c)a.removeAttribute(g,c[g]);if(b.styles)for(var e in b.styles)b.styles.hasOwnProperty(e)&&a.removeStyle(e)
            }
        }
function i(a){
    ...
    for(var g,f=a.document;g=c.getNextParagraph();)if(!g.isReadOnly()){
        var d=m(this,f,g);
        e(g,d)
        }
        a.moveToBookmark(b)
    ...
    for(var g;g=c.getNextParagraph();)if(this.checkElementRemovable(g))if(g.is("pre")){
        ...
        e(g,f)
        }else q.call(this,g);a.moveToBookmark(b)
    }
    function e(a,b){
    var c=!b;
    if(c){
        ...
        var e=b&&b.is("pre"),f=a.is("pre"),d=!e&&f;
    if(e&&!f){
        f=b;
    ...
    function j(a,b,c){
    var g="",e="",a=a.replace(/(^<span[^>]+data-cke-bookmark.*?\/span>)|(<span[^>]+data-cke-bookmark.*?\/span>$)/gi,function(a,b,c){
        b&&(g=b);
        c&&(e=c);
        return""
        });
    ...
    function q(a){
    var b=this._.definition,c=b.attributes,b=b.styles,g=r(this)[a.getName()],e=CKEDITOR.tools.isEmpty(c)&&CKEDITOR.tools.isEmpty(b),
    f;
    for(f in c)if(!((f=="class"||this._.definition.fullMatch)&&a.getAttribute(f)!=t(f,c[f]))){
        e=a.hasAttribute(f);
        a.removeAttribute(f)
        }
        for(var d in b)if(!(this._.definition.fullMatch&&a.getStyle(d)!=t(d,b[d],true))){
        e=e||!!a.getStyle(d);
        a.removeStyle(d)
        }
        n(a,g,v[a.getName()]);
    ...
    function n(a,b,c){
    if(b=b&&b.attributes)for(var g=0;g<b.length;g++){
        var e=b[g][0],f;
...
function m(a,b,c){
    ...
    function p(a,b){
    var c=b._.definition,g=c.attributes,c=CKEDITOR.style.getStyleText(c);
    if(g)for(var e in g)a.setAttribute(e,g[e]);c&&a.setAttribute("style",c);
    return a
    }
    function s(a,b){
...
function t(a,b,c){
    ...
    audio:1,
    video:1
},x=/\s*(?:;\s*|$)/,y=/#\((.+?)\)/g,z=CKEDITOR.dom.walker.bookmark(0,1),D=CKEDITOR.dom.walker.whitespaces(1);
...
CKEDITOR.style.prototype={
    ...
    checkActive:function(a){
        switch(this.type){
            ...
            case CKEDITOR.STYLE_OBJECT:case CKEDITOR.STYLE_INLINE:
        ...
        if(g=c._AC)c=g;
            ...
            for(var h in c)if(h!="_length"){
                ...
                if(h=="style")a:{
                    ...
                    d=void 0;
                    for(d in g)if(!(d in e&&(e[d]==g[d]||g[d]=="inherit"||e[d]=="inherit"))){
                        g=false;
                        break a
                    }
                    g=true
...
buildPreview:function(a){
    var b=this._.definition,c=[],g=b.element;
    g=="bdo"&&(g="span");
    var c=["<",g],e=b.attributes;
...
CKEDITOR.style.getStyleText=function(a){
    var b=a._ST;
    if(b)return b;
    var b=a.styles,c=a.attributes&&a.attributes.style||"",g="";
    c.length&&(c=c.replace(x,";"));
    for(var e in b){
        var f=b[e],d=(e+":"+f).replace(x,";");
...
CKEDITOR.editor.prototype.getStylesSet=function(a){
    if(this._.stylesDefinitions)a(this._.stylesDefinitions);
        ...
        var b=this,c=b.config.stylesCombo_stylesSet||b.config.stylesSet||"default";
...
(function(){
    var a={},b;
    for(b in CKEDITOR.dtd.$blockLimit)b in CKEDITOR.dtd.$list||(a[b]=1);var c={};
    
    for(b in CKEDITOR.dtd.$block)b in CKEDITOR.dtd.$blockLimit||b in CKEDITOR.dtd.$empty||(c[b]=1);CKEDITOR.dom.elementPath=function(b,d){
        var i=null,f=null,e=[],d=d||b.getDocument().getBody(),g=b;
...
CKEDITOR.dom.elementPath.prototype={
    compare:function(a){
        ...
        for(var c=0;c<b.length;c++)if(!b[c].equals(a[c]))return false;
        return true
        },
    contains:function(a,b,c){
        ...
        if(c){
            ...
            for(b=0;b<i;b++)if(h(d[b]))return d[b];return null
        },
...
CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype,{
    ...
    split:function(a){
        var b=
        this.$.parentNode,c=b.childNodes.length,h=this.getLength(),d=this.getDocument(),i=new CKEDITOR.dom.text(this.$.splitText(a),d);
        if(b.childNodes.length==c)if(a>=h){
            i=d.createText("");
            i.insertAfter(this)
            }else{
            a=d.createText("");
...
(function(){
    function a(a,b,d){
        var i=a.serializable,f=b[d?"endContainer":"startContainer"],e=d?"endOffset":"startOffset",g=i?b.document.getById(a.startNode):
        a.startNode,a=i?b.document.getById(a.endNode):a.endNode;
    ...
    var b={
        createIterator:function(){
            var a=this,b=CKEDITOR.dom.walker.bookmark(),d=[],i;
            return{
                getNextRange:function(f){
                    i=i==void 0?0:i+1;
                    var e=a[i];
                    if(e&&a.length>1){
                        if(!i)for(var g=a.length-1;g>=0;g--)d.unshift(a[g].createBookmark(true));
                        if(f)for(var j=0;a[i+j+1];){
...
(function(){
    function a(){
        ...
        function b(b){
        var c=CKEDITOR.skin["ua_"+b],g=CKEDITOR.env;
...
function h(a){
    ...
    if(CKEDITOR.env.webkit){
        ...
        for(e=0;e<b.length;e++)b[e]=b[e].split("{")
            ...
            for(var d=0;d<a.length;d++)if(CKEDITOR.env.webkit)for(e=0;e<b.length;e++){
        f=b[e][1];
...
var f="cke_ui_color",e=[],g=/\$color/g;
    ...
    if(!CKEDITOR.env.ie||!CKEDITOR.env.quirks){
        ...
        b.on("menuShow",function(a){
            ...
            if(!a.getById("cke_ui_color")){
                ...
                e.push(a);
                var c=b.getUiColor();
                c&&d([a],CKEDITOR.skin.chameleon(b,"panel"),[[g,c]])
                }
            });
...
CKEDITOR.plugins.add("dialogui",{
    ...
    },true),i=/^on([A-Z]\w+)/,f=function(a){
    for(var b in a)(i.test(b)||b=="title"||b=="type")&&delete a[b];return a
    };
...
textInput:function(b,c,f){
    if(!(arguments.length<3)){
        a.call(this,c);
        var d=this._.inputId=CKEDITOR.tools.getNextId()+"_textInput",h={
    ...
    CKEDITOR.ui.dialog.labeledElement.call(this,
        b,c,f,function(){
            ...
            for(var b in h)a.push(b+'="'+h[b]+'" ');a.push(" /></div>");
            return a.join("")
            })
    }
},
textarea:function(b,c,f){
    if(!(arguments.length<3)){
        a.call(this,c);
        var d=this,h=this._.inputId=CKEDITOR.tools.getNextId()+"_textarea",i={};
        ...
        CKEDITOR.ui.dialog.labeledElement.call(this,b,c,f,function(){
            ...
            var a=['<div class="cke_dialog_ui_input_textarea" role="presentation"><textarea class="cke_dialog_ui_input_textarea" id="',h,'" '],b;
            for(b in i)a.push(b+'="'+CKEDITOR.tools.htmlEncode(i[b])+'" ');a.push(">",CKEDITOR.tools.htmlEncode(d._["default"]),"</textarea></div>");
            return a.join("")
            })
        }
    },
    ...
    if(!(arguments.length<3)){
        ...
        CKEDITOR.ui.dialog.uiElement.call(this,b,c,d,"span",null,null,function(){
            var a=CKEDITOR.tools.extend({},c,{
                ...
                },true),d=[],j=CKEDITOR.tools.getNextId()+"_label",i={
        ...
        CKEDITOR.ui.dialog.labeledElement.call(this,
            b,c,d,function(){
                for(var a=[],d=[],j=c.id?c.id+"_radio":CKEDITOR.tools.getNextId()+"_radio",m=0;m<c.items.length;m++){
                    var p=c.items[m],s=p[2]!==void 0?p[2]:p[0],r=p[1]!==void 0?p[1]:p[0],t=CKEDITOR.tools.getNextId()+"_radio_input",u=t+"_label",t=CKEDITOR.tools.extend({},c,{
                        id:t,
                        title:null,
                        type:null
                    },true),s=CKEDITOR.tools.extend({},t,{
                        title:s
                    },true),v={
                        type:"radio",
...
file:function(b,c,f){
    if(!(arguments.length<3)){
        ...
        CKEDITOR.ui.dialog.labeledElement.call(this,b,c,f,function(){
            ...
            var a=CKEDITOR.env.isCustomDomain(),b=['<iframe frameborder="0" allowtransparency="0" class="cke_dialog_ui_input_file" role="presentation" id="',d.frameId,'" title="',c.label,
            '" src="javascript:void('];
...
fileButton:function(b,c,f){
    if(!(arguments.length<3)){
        ...
        var d=this;
        if(c.validate)this.validate=c.validate;
        var h=CKEDITOR.tools.extend({},c),i=h.onClick;
...
CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement,{
    ...
    add:function(a,b,c){
        var f=new CKEDITOR.dom.element("option",this.getDialog().getParentEditor().document),d=this.getInputElement().$;
        f.$.text=a;
...
CKEDITOR.ui.dialog.radio.prototype=CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement,{
    ...
    getValue:function(){
        for(var a=this._.children,b=0;b<a.length;b++)if(a[b].getElement().$.checked)return a[b].getValue();return null
        },
    accessKeyUp:function(){
...
CKEDITOR.ui.dialog.file.prototype=CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement,h,{
    ...
    registerEvents:function(a){
        var b=/^on([A-Z]\w+)/,c,f=function(a,b,c,f){
            a.on("formLoaded",function(){
                a.getInputElement().on(c,f,a)
                })
            },d;
        for(d in a)if(c=d.match(b))this.eventProcessors[d]?this.eventProcessors[d].call(this,this._.dialog,a[d]):f(this,this._.dialog,c[1].toLowerCase(),a[d]);return this
        },
    reset:function(){
        function a(){
            c.$.open();
            ...
            c.$.write(['<html dir="'+o+'" lang="'+m+'"><head><title></title></head><body style="margin: 0; overflow: hidden; background: transparent;">','<form enctype="multipart/form-data" method="POST" dir="'+o+'" lang="'+m+'" action="',CKEDITOR.tools.htmlEncode(f.action),'"><label id="',b.labelId,'" for="',s,'" style="display:none">',CKEDITOR.tools.htmlEncode(f.label),'</label><input id="',s,'" aria-labelledby="',b.labelId,
                '" type="file" name="',CKEDITOR.tools.htmlEncode(f.id||"cke_upload"),'" size="',CKEDITOR.tools.htmlEncode(e>0?e:""),'" /></form></body></html>',"<script>window.parent.CKEDITOR.tools.callFunction("+h+");","window.onbeforeunload = function() {window.parent.CKEDITOR.tools.callFunction("+i+")}<\/script>"].join(""));
            c.$.close();
            for(e=0;e<d.length;e++)d[e].enable()
                }
                var b=this._,c=CKEDITOR.document.getById(b.frameId).getFrameDocument(),f=b.definition,d=b.buttons,h=this.formLoadedNumber,i=this.formUnloadNumber,
        o=b.dialog._.editor.lang.dir,m=b.dialog._.editor.langCode;
        if(!h){
...
(function(){
    function a(){
        for(var a=this._.tabIdList.length,b=CKEDITOR.tools.indexOf(this._.tabIdList,this._.currentTabId)+a,c=b-1;c>b-a;c--)if(this._.tabs[this._.tabIdList[c%a]][0].$.offsetHeight)return this._.tabIdList[c%a];return null
        }
        function b(){
        for(var a=
    ...
    var a=CKEDITOR.dom.element.createFromHtml(CKEDITOR.addTemplate("dialog",o).output({
        ...
        })),b=a.getChild([0,0,0,0,0]),c=b.getChild(0),f=b.getChild(1);
    if(CKEDITOR.env.ie&&!CKEDITOR.env.ie6Compat){
        var d=CKEDITOR.env.isCustomDomain(),d="javascript:void(function(){"+encodeURIComponent("document.open();"+(d?'document.domain="'+document.domain+'";':"")+"document.close();")+"}())";
...
function f(a,b,c){
    ...
    function g(a){
    function b(c){
        var j=a.getSize(),i=CKEDITOR.document.getWindow().getViewPaneSize(),k=c.data.$.screenX,n=c.data.$.screenY,m=k-f.x,o=n-f.y;
        f={
            x:k,
            y:n
        };
...
var g=a.getParentEditor(),e=g.config.dialog_magnetDistance,h=CKEDITOR.skin.margins||[0,0,0,0];
...
function j(a){
    var b,c;
    function f(d){
        var m=h.lang.dir=="rtl",o=n.width,p=n.height,q=o+(d.data.$.screenX-b)*(m?-1:1)*(a._.moved?1:2),l=p+(d.data.$.screenY-c)*(a._.moved?1:2),u=a._.element.getFirst(),u=m&&u.getComputedStyle("right"),s=a.getPosition();
    ...
    var g=a.definition,e=
g.resizable;
if(e!=CKEDITOR.DIALOG_RESIZE_NONE){
    var h=a.getParentEditor(),j,i,k,n,m,o=CKEDITOR.tools.addFunction(function(g){
        n=a.getSize();
...
function k(a){
    ...
    function q(a){
    var b=CKEDITOR.document.getWindow(),c=a.config,f=c.dialog_backgroundCoverColor||"white",d=c.dialog_backgroundCoverOpacity,g=c.baseFloatZIndex,c=CKEDITOR.tools.genKey(f,d,g),e=v[c];
    if(e)e.show();
    else{
        g=
        ['<div tabIndex="-1" style="position: ',CKEDITOR.env.ie6Compat?"absolute":"fixed","; z-index: ",g,"; top: 0px; left: 0px; ",!CKEDITOR.env.ie6Compat?"background-color: "+f:"",'" class="cke_dialog_background_cover">'];
        if(CKEDITOR.env.ie6Compat){
            var h=CKEDITOR.env.isCustomDomain(),f="<html><body style=\\'background-color:"+f+";\\'></body></html>";
...
CKEDITOR.dialog=function(c,f){
    ...
    if(v==
        ...
        var d=f.data.getKeystroke(),e=c.lang.dir=="rtl";
        r=x=0;
...
function o(a){
    ...
    var p=CKEDITOR.dialog._.dialogDefinitions[f],q=CKEDITOR.tools.clone(m),l=c.config.dialog_buttonsOrder||"OS",u=c.lang.dir,s={},r,x;
...
if(c._.removeDialogTabs&&(s=c._.removeDialogTabs[f]))for(u=0;u<s.length;u++)p.removeContents(s[u]);
...
move:function(){
    ...
    return function(b,c,d){
        ...
        if(!a||!this._.position||!(this._.position.x==b&&this._.position.y==c)){
            ...
            if(!a)var g=CKEDITOR.document.getWindow().getScrollPosition(),b=b+g.x,c=c+g.y;
            if(e){
                g=this.getSize();
...
layout:function(){
    var a=CKEDITOR.document.getWindow().getViewPaneSize(),b=this.getSize();
    this.move(this._.moved?this._.position.x:(a.width-b.width)/2,this._.moved?this._.position.y:(a.height-b.height)/2)
    },
foreach:function(a){
    for(var b in this._.contents)for(var c in this._.contents[b])a.call(this,this._.contents[b][c]);return this
    },
reset:function(){
    var a=function(a){
        a.reset&&a.reset(1)
...
addPage:function(a){
    var b=[],c=a.label?' title="'+CKEDITOR.tools.htmlEncode(a.label)+'"':"",d=CKEDITOR.dialog._.uiElementBuilders.vbox.build(this,{
        type:"vbox",
    ...
    var f=CKEDITOR.env,e="cke_"+
    a.id+"_"+CKEDITOR.tools.getNextNumber(),c=CKEDITOR.dom.element.createFromHtml(['<a class="cke_dialog_tab"',this._.pageCount>0?" cke_last":"cke_first",c,a.hidden?' style="display:none"':"",' id="',e,'"',f.gecko&&f.version>=10900&&!f.hc?"":' href="javascript:void(0)"',' tabIndex="-1" hidefocus="true" role="tab">',a.label,"</a>"].join(""));
...
var m={
    ...
    for(var d=0,f;f=a[d];d++){
        if(f.id==b)return f;
        if(c&&f[c])if(f=p(f[c],b,c))return f
            }
            return null
...
var u,v={},w,x={},y=function(a){
    ...
    d=a.data.$.shiftKey,f=String.fromCharCode(a.data.$.keyCode);
    if((b=x[(b?"CTRL+":"")+(c?"ALT+":"")+(d?"SHIFT+":"")+f])&&b.length){
        b=b[b.length-1];
        if(b.keyup){
...
(function(){
    CKEDITOR.ui.dialog={
        uiElement:function(a,b,c,d,f,e,g){
            if(!(arguments.length<4)){
                var h=(d.call?d(b):d)||"div",j=["<",h," "],i=(f&&f.call?f(b):f)||{},k=(e&&e.call?e(b):e)||{},n=(g&&g.call?g.call(this,a,b):g)||"",p=this.domId=k.id||CKEDITOR.tools.getNextId()+"_uiElement";
                this.id=b.id;
                k.id=p;
                var m={};
                ...
                o=[];
                for(p in m)o.push(p);k["class"]=o.join(" ");
                ...
                if(b.align){
                    ...
                    for(p in i)m.push(p+":"+i[p]);b.hidden&&m.push("display:none");
...
hbox:function(a,b,c,d,f){
    if(!(arguments.length<4)){
        this._||(this._={});
        var e=this._.children=b,g=f&&f.widths||null,h=f&&f.height||null,j,i={
            role:"presentation"
        };
...
CKEDITOR.ui.dialog.uiElement.prototype={
    ...
    registerEvents:function(a){
        ...
        for(f in a)if(c=f.match(b))this.eventProcessors[f]?this.eventProcessors[f].call(this,this._.dialog,a[f]):d(this,this._.dialog,
            c[1].toLowerCase(),a[f]);return this
        },
    eventProcessors:{
        onLoad:function(a,b){
            a.on("load",b,this)
...
(function(){
    var a=/^([a]|[^a])+$/,b=/^\d*$/,c=/^\d*(?:\.\d+)?$/,d=/^(((\d*(\.\d+))|(\d*))(px|\%)?)?$/,f=/^(((\d*(\.\d+))|(\d*))(px|em|ex|in|cm|mm|pt|pc|\%)?)?$/i,e=/^(\s*[\w-]+\s*:\s*[^:;]+(?:;|$))*$/;
    ...
    CKEDITOR.dialog.validate={
        functions:function(){
            ...
            return function(){
                var b=
                this&&this.getValue?this.getValue():a[0],c=void 0,d=CKEDITOR.VALIDATE_AND,f=[],e;
                for(e=0;e<a.length;e++)if(typeof a[e]=="function")f.push(a[e]);else break;if(e<a.length&&typeof a[e]=="string"){
                    c=a[e];
                    e++
                }
    ...
    CKEDITOR.plugins.add("a11yhelp",{
        ...
        init:function(a){
            ...
            a.addCommand("a11yHelp",{
                exec:function(){
                    var c=a.langCode,c=b.availableLangs[c]?c:"en";
...
CKEDITOR.plugins.add("basicstyles",{
    init:function(a){
        var b=0,c=function(c,d,e,g){
            ...
            },h=a.config,d=a.lang.basicstyles;
...
function c(c){
    return{
        ...
        refresh:function(a,b){
            var c=a.config.useComputedState,d,c=c===void 0||c;
            if(!c){
                d=b.lastElement;
    ...
    exec:function(f){
        var e=f.getSelection(),g=f.config.enterMode,h=e.getRanges();
        if(h&&h.length){
            for(var j={},p=e.createBookmarks(),h=h.createIterator(),s,r=0;s=h.getNextRange(1);){
                ...
                t&&a(t,c,f,j);
                var u=new CKEDITOR.dom.walker(s),v=p[r].startNode,w=p[r++].endNode;
...
function h(a){
    var b=a==e.setAttribute,c=a==e.removeAttribute,d=/\bdirection\s*:\s*(.*?)\s*(:?$|;)/;
    return function(f,e){
...
(function(){
    var a={
        exec:function(a){
            var c=a.getCommand("blockquote").state,h=a.getSelection(),d=h&&h.getRanges(true)[0];
            if(d){
                var i=h.createBookmarks();
                if(CKEDITOR.env.ie){
                    var f=
                    i[0].startNode,e=i[0].endNode,g;
                    if(f&&f.getParent().getName()=="blockquote")for(g=f;g=g.getNext();)if(g.type==CKEDITOR.NODE_ELEMENT&&g.isBlockBoundary()){
                        f.move(g,true);
                        break
                    }
                    if(e&&e.getParent().getName()=="blockquote")for(g=e;g=g.getPrevious();)if(g.type==CKEDITOR.NODE_ELEMENT&&g.isBlockBoundary()){
                        e.move(g);
                        break
                    }
                    }
        ...
        for(e=f.length-1;e>=0;e--){
            ...
            f[e];
                a:{
                g=d;
                for(var j=0,k=g.getChildCount(),q=void 0;j<k&&(q=g.getChild(j));j++)if(q.type==CKEDITOR.NODE_ELEMENT&&q.isBlockBoundary()){
                    g=false;
                    break a
                }
                g=true
            ...
            if(a.config.enterMode==CKEDITOR.ENTER_BR)for(d=true;c.length;){
            j=c.shift();
            if(j.getName()=="div"){
    ...
    function a(a){
        ...
        return{
            ...
            exec:function(){
                ...
                var b;
                var c=this.type;
                if(CKEDITOR.env.ie)b=l(c);else try{
...
function h(){
    ...
    function l(b){
    var c=a.document,d=c.getBody(),e=false,g=function(){
        e=true
        };
...
function m(b,c){
    ...
    if(!d.getById("cke_pastebin")){
        var j=a.getSelection(),i=
        j.createBookmarks(),k=new CKEDITOR.dom.element(e.is("body")&&!CKEDITOR.env.ie&&!CKEDITOR.env.opera?"body":"div",d);
...
function t(b){
    ...
    var u=0,v=0,w=0,x=CKEDITOR.env.ie?"beforepaste":"paste";
(function(){
    a.on("key",p);
    a.on("contentDom",b);
...
function b(a){
    ...
    b={
        ...
        br:1,
        "cke:br":1
    },h=CKEDITOR.dtd,i=CKEDITOR.tools.extend({
        area:1,
        basefont:1,
        embed:1,
        iframe:1,
...
function d(a,b,c){
    ...
    b.writeHtml(d,c);
    var b=d.getHtml(),b=b.replace(/\s*(<\/?[a-z:]+ ?\/?>)\s*/g,"$1").replace(/(<cke:br \/>){2,}/g,"<cke:br />").replace(/(<cke:br \/>)(<\/?p>|<br \/>)/g,"$2").replace(/(<\/?p>|<br \/>)(<cke:br \/>)/g,"$1").replace(/<(cke:)?br( \/)?>/g,"<br>").replace(/<p><\/p>/g,""),h=0,b=
    ...
    init:function(f){
        ...
        f.on("paste",function(a){
            var a=a.data,j=a.type,i=a.dataValue,q,l=f.config.clipboard_defaultContentType||
            "html";
...
(function(){
    ...
    b=CKEDITOR.addTemplate("buttonArrow",'<span class="cke_button_arrow">'+(CKEDITOR.env.hc?"&#9660;":"&nbsp;")+"</span>"),c=CKEDITOR.addTemplate("button",a);
...
CKEDITOR.ui.button.prototype={
    render:function(a,d){
        var i=CKEDITOR.env,f=this._.id=CKEDITOR.tools.getNextId(),e="",g=this.command,j;
        this._.editor=a;
        var k={
            id:f,
            button:this,
...
proto:{
    createPanel:function(a){
        var c=this._;
        if(!c.panel){
            var h=this._.panelDefinition||{},d=this._.panelDefinition.block,i=h.parent||CKEDITOR.document.getBody(),f=this._.panel=new CKEDITOR.ui.floatPanel(a,i,h),h=f.addBlock(c.id,d),e=this;
            f.onShow=function(){
...
(function(){
    function a(a,h,d,i,f){
        var f=CKEDITOR.tools.genKey(h.getUniqueId(),
            d.getUniqueId(),a.lang.dir,a.uiColor||"",i.css||"",f||""),e=b[f];
        if(!e){
    ...
    CKEDITOR.ui.floatPanel=CKEDITOR.tools.createClass({
        $:function(b,h,d,i){
            d.forceIFrame=1;
            var f=h.getDocument(),i=a(b,f,h,d,i||0),e=i.element,g=e.getFirst();
        ...
        proto:{
            ...
            showBlock:function(a,b,d,i,f){
                var e=this._.panel,g=e.showBlock(a);
                this.allowBlur(false);
                a=this._.editor.editable();
                this._.returnFocus=a.hasFocus?a:new CKEDITOR.dom.element(CKEDITOR.document.$.activeElement);
                var j=this.element,a=this._.iframe,
                k=b.getDocumentPosition(j.getDocument()),q=this._.dir=="rtl",l=k.x+(i||0),n=k.y+(f||0);
            ...
            CKEDITOR.tools.setTimeout(function(){
                var a=CKEDITOR.tools.bind(function(){
                    ...
                    var b=e.element.getWindow(),a=j.$.getBoundingClientRect(),b=b.getViewPaneSize(),c=a.width||a.right-a.left,d=a.height||a.bottom-a.top,f=q?a.right:b.width-a.left,h=q?b.width-a.right:a.left;
...
CKEDITOR.on("instanceDestroyed",
    function(){
        var a=CKEDITOR.tools.isEmpty(CKEDITOR.instances),h;
        for(h in b){
            var d=b[h];
...
CKEDITOR.plugins.add("colorbutton",{
    ...
    init:function(a){
        function b(b,d,g,h){
            ...
            onOpen:function(){
                var b=a.getSelection(),b=b&&b.getStartElement(),b=a.elementPath(b),c,b=b.block||b.blockLimit||a.document.getBody();
    ...
    function c(b,c,g){
    var j=[],k=d.colorButton_colors.split(","),q=CKEDITOR.tools.addFunction(function(c,g){
        if(c=="?"){
            var e=arguments.callee,i=function(a){
...
j.push("</tr></table>");
    ...
    var d=a.config,i=a.lang.colorbutton;
if(!CKEDITOR.env.hc){
...
(function(){
    ...
    _:{
        onShow:function(){
            var a=
            this.editor.getSelection(),b=a&&a.getStartElement(),c=this.editor.elementPath(),e=this._.listeners;
            this.removeAll();
...
proto:{
    ...
    show:function(b,c,f,e){
        ...
        var c=c||(this.editor.lang.dir=="rtl"?2:1),g=this.items,h=this.editor,k=this._.panel,q=this._.element;
        if(!k){
            ...
            this._.itemClickFn=CKEDITOR.tools.addFunction(function(a){
                ...
                else if(b.getItems)this._.showSubMenu(a);else this._.onClick(b)
                    },this)
            }
            a(g);
...
CKEDITOR.menuItem=CKEDITOR.tools.createClass({
    ...
    proto:{
        render:function(a,b,f){
            ...
            "undefined"?CKEDITOR.TRISTATE_OFF:this.state,g=this.getItems,j="&"+(this.editor.lang.dir=="rtl"?"9668":"9658")+";",a={
                id:a.id+(""+b),
                name:this.name,
                label:this.label,
    ...
    onLoad:function(){
        ...
        proto:{
            ...
            if(!b||!(CKEDITOR.env.webkit?h:CKEDITOR.env.mac?a.$.metaKey:a.$.ctrlKey)){
                a.preventDefault();
                var c=a.getTarget().getDocument(),d=a.getTarget().getDocument().getDocumentElement(),g=!c.equals(CKEDITOR.document),c=c.getWindow().getScrollPosition(),j=g?a.$.clientX:a.$.pageX||c.x+a.$.clientX,k=g?a.$.clientY:a.$.pageY||c.y+
                a.$.clientY;
                CKEDITOR.tools.setTimeout(function(){
    ...
    CKEDITOR.plugins.add("elementspath",{
        init:function(c){
            function i(a){
                ...
                var e=c.ui.spaceId("path"),g,j="cke_elementspath_"+CKEDITOR.tools.getNextNumber()+"_";
            c._.elementsPath={
                idBase:j,
                filters:[]
            };
            ...
            var k=CKEDITOR.tools.addFunction(i),q=CKEDITOR.tools.addFunction(function(a,b){
                var f=c._.elementsPath.idBase,g,b=new CKEDITOR.dom.event(b);
                g=c.lang.dir=="rtl";
...
(function(){
    ...
    for(e=0;e<g.length;e++){
        ...
        for(e=h+1;e<f.length;e++)if(f[e].indent>f[e-1].indent+1){
    ...
    var j=CKEDITOR.plugins.list.arrayToList(f,c,null,a.config.enterMode,b.root.getAttribute("dir")).listNode,i,k;
    d(true);
    d();
    j.replace(b.root)
    }
...
function i(a){
    ...
    b.trim(false,true);
    var g=b.createBookmark(),j=a.elementPath(b.startContainer),i=j.lastElement.getAscendant("li",1);
    ...
    f=d.startPath();
    if(f=f.contains("li"))if(j=e(f))if(i.contains(f)){
        c(j,f.getParent(),f);
        j.remove()
        }else i.append(j);
    ...
    ol:1,
    ul:1
},j=CKEDITOR.dom.walker.whitespaces(),k=CKEDITOR.dom.walker.bookmark(),q=function(a){
    return!(j(a)||k(a))
...
arrayToList:function(a,
    ...
    for(var e,h=a[c].parent.getDocument(),j=new CKEDITOR.dom.documentFragment(h),i=null,k=c,m=Math.max(a[c].indent,0),p=null,n,o,l=d==CKEDITOR.ENTER_P?"p":"div";;){
        ...
        if(s.indent==m){
            ...
            var i=e.getDirection(1)!=n,r=s.element,t=r.getAttribute("class"),O=r.getAttribute("style"),
            H=p.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT&&(d!=CKEDITOR.ENTER_BR||i||O||t),M,Q=s.contents.length;
            for(e=0;e<Q;e++){
                M=s.contents[e];
                if(M.type==CKEDITOR.NODE_ELEMENT&&M.isBlockBoundary()){
                    i&&!M.getDirection()&&M.setAttribute("dir",n);
                    var N=M,R=r.getAttribute("style");
...
var n=/^h[1-6]$/,o=CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_ELEMENT);
b.prototype={
    exec:function(b){
        this.refresh(b,b.elementPath());
        var c=b.config,d=b.getSelection(),f=d&&d.getRanges(true);
        ...
        for(var c=d.createBookmarks(true),e=[],i={},f=f.createIterator(),k=0;(j=f.getNextRange())&&++k;){
        var p=j.getBoundaryNodes(),m=p.startNode,o=p.endNode;
        ...
        j=j.createIterator();
        for(j.forceBrBreak=this.state==CKEDITOR.TRISTATE_OFF;p=j.getNextParagraph();)if(!p.getCustomData("list_block")){
            CKEDITOR.dom.element.setMarker(i,p,"list_block",1);
            for(var l=b.elementPath(p),m=l.elements,o=0,l=l.blockLimit,s,r=m.length-1;r>=0&&(s=m[r]);r--)if(g[s.getName()]&&l.contains(s)){
    ...
    for(s=[];e.length>0;){
    m=e.shift();
    if(this.state==CKEDITOR.TRISTATE_OFF)if(g[m.root.getName()]){
        p=b;
        f=m;
        m=i;
        k=s;
        ...
        var C=l[j].getCustomData("listarray_index"),t=o[C].parent;
        if(!t.is(this.type)){
    ...
    o=m=void 0;
    t=t===void 0||t;
    for(r=0;r<l.length;r++)for(I=l[r];C=I.getParent();){
        if(C.equals(p)){
            k.push(I);
...
refresh:function(a,b){
    var c=b.blockLimit||b.root,d=b.contains(this.type,1);
    d&&c.contains(d)?this.setState(CKEDITOR.TRISTATE_ON):this.setState(CKEDITOR.TRISTATE_OFF)
    }
};

var m=CKEDITOR.dtd,p=/[\t\r\n ]*(?:&nbsp;|\xa0)$/,s={
    elements:{}
},r;
for(r in m.$listItem)s.elements[r]=d();var t={
    elements:{}
};
        ...
        if(!a.blockless){
            ...
            if(a.ui.addButton){
                ...
                if(a.mode=="wysiwyg"&&c in{
                    ...
                    h=d.startPath();
                    if(d.collapsed){
                        var j=c==8,k=a.editable(),p=new CKEDITOR.dom.walker(d.clone());
...
(function(){
    function a(a,b){
        ...
        ol:1,
        ul:1
    },d=CKEDITOR.dom.walker.whitespaces(true),i=CKEDITOR.dom.walker.bookmark(false,true);
    a.prototype={
        context:"p",
        refresh:function(a,c){
            var d=c&&c.contains(h),j=c.block||c.blockLimit;
            ...
            else if(j)if(this.useIndentClasses){
            ...
            function e(b){
                ...
                if(c&&e){
                    for(var g=c,c=[],j=false;!j;){
                        ...
                        if(!(c.length<1)){
                        g=b.getParents(true);
                        for(e=0;e<g.length;e++)if(g[e].getName&&h[g[e].getName()]){
                            b=g[e];
                            break
                        }
                    ...
                    if(k.name=="outdent"){
                        var n;
                        if((n=b.getParent())&&n.is("li"))for(var g=c.listNode.getChildren(),l=[],r,e=g.count()-1;e>=0;e--)(r=g.getItem(e))&&(r.is&&r.is("li"))&&l.push(r)
                            }
                            c&&c.listNode.replace(b);
                    if(l&&l.length)for(e=0;e<l.length;e++){
                        for(r=
                            b=l[e];(r=r.getNext())&&r.is&&r.getName()in h;){
...
function g(){
    var b=o.createIterator(),c=a.config.enterMode;
    ...
    if(k.useIndentClasses){
        var e=c.$.className.match(k.classNameRegex),g=
        0;
        if(e){
            e=e[1];
        ...
        isNaN(g)&&(g=0);
        var h=a.config.indentOffset||40,g=g+(k.name=="indent"?1:-1)*h;
        if(g<0)return false;
        g=Math.max(g,0);
        g=Math.ceil(g/h)*h;
    ...
    if(p){
    var s=p.getFirst(c),r=!!s.getNext(c),t=o.startContainer;
    ...
    init:function(b){
        if(!b.blockless){
            ...
            if(b.ui.addButton){
                ...
                for(var d=new CKEDITOR.dom.walker(c),h;h=d.next();)if(h.type==CKEDITOR.NODE_ELEMENT)if(!h.equals(a.data.node)&&h.getDirection()){
                    c.setStartAfter(h);
                    d=new CKEDITOR.dom.walker(c)
                    }else{
                    var i=b.config.indentClasses;
                    if(i)for(var l=a.data.dir=="ltr"?["_rtl",""]:["",
                        "_rtl"],n=0;n<i.length;n++)if(h.hasClass(i[n]+l[0])){
...
(function(){
    ...
    b.setKeystroke([[13,"enter"],[CKEDITOR.SHIFT+
        13,"shiftEnter"]])
    }
    });
var c=CKEDITOR.dom.walker.whitespaces(),h=CKEDITOR.dom.walker.bookmark();
CKEDITOR.plugins.enterkey={
    enterBlock:function(a,d,f,q){
        if(f=f||b(a)){
            var l=f.document,n=f.checkStartOfBlock(),o=f.checkEndOfBlock(),m=a.elementPath(f.startContainer).block;
            if(n&&o){
        ...
        var m=d==CKEDITOR.ENTER_DIV?"div":"p",p=f.splitBlock(m);
        if(p){
            var d=p.previousBlock,a=p.nextBlock,n=p.wasStartOfBlock,o=p.wasEndOfBlock,s;
            if(a){
                s=a.getParent();
                if(s.is("li")){
                    a.breakParent(s);
...
enterBr:function(a,c,d,h){
    if(d=d||b(a)){
        var i=d.document,n=d.checkEndOfBlock(),o=new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()),m=o.block,o=m&&o.block.getName();
        if(!h&&o=="li")f(a,c,d,h);
        else{
            if(!h&&n&&e.test(o))if(n=m.getDirection()){
...
var d=CKEDITOR.plugins.enterkey,i=d.enterBr,f=d.enterBlock,e=/^h[1-6]$/
})();
(function(){
    function a(a,c){
        var h={},d=[],i={
        ...
        if(!c&&a){
            var a=a.split(","),f=document.createElement("div"),e;
            f.innerHTML="&"+a.join(";&")+";";
            e=f.innerHTML;
            f=null;
    ...
    afterInit:function(b){
        ...
        if(b=(b=b.dataProcessor)&&b.htmlFilter){
            ...
            if(c.entities){
                ...
                var d=a(h.join(",")),i=d.regex?"["+d.regex+"]":"a^";
            delete d.regex;
            c.entities&&c.entities_processNumerical&&(i="[^ -~]|"+i);
            var i=RegExp(i,"g"),f=function(a){
                return c.entities_processNumerical=="force"||!d[a]?"&#"+a.charCodeAt(0)+";":d[a]
                },e=a("nbsp,gt,lt,amp,shy",true),g=RegExp(e.regex,"g"),j=function(a){
                return e[a]
                };
...
CKEDITOR.tools.extend(CKEDITOR.editor.prototype,{
    popup:function(a,b,c,h){
        ...
        c<420&&(c=
            420);
        var d=parseInt((window.screen.height-c)/2,10),i=parseInt((window.screen.width-b)/2,10),h=(h||"location=no,menubar=no,toolbar=no,dependent=yes,minimizable=no,modal=yes,alwaysRaised=yes,resizable=yes,scrollbars=yes")+",width="+b+",height="+c+",top="+d+",left="+i,f=window.open("",null,h,true);
        if(!f)return false;
        try{
...
(function(){
    function a(a,
        ...
        var f=d.config["filebrowser"+b(c.getName())+"WindowWidth"]||d.config.filebrowserWindowWidth||"80%",c=d.config["filebrowser"+b(c.getName())+"WindowHeight"]||d.config.filebrowserWindowHeight||"70%",e=this.filebrowser.params||
...
function f(a,b,c){
    if(c.indexOf(";")!==-1){
        for(var c=c.split(";"),d=0;d<c.length;d++)if(f(a,
            b,c[d]))return true;return false
        }
...
CKEDITOR.on("dialogDefinition",function(a){
    var b=a.data.definition,c,d;
    for(d in b.contents)if(c=b.contents[d]){
...
(function(){
    function a(a,b){
        ...
        var b=CKEDITOR.htmlParser.cssStyle,c=CKEDITOR.tools.cssLength,h=/^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i,d={
        elements:{
            $:function(c){
                var d=c.attributes;
                if((d=(d=(d=d&&d["data-cke-realelement"])&&new CKEDITOR.htmlParser.fragment.fromHtml(decodeURIComponent(d)))&&d.children[0])&&
                    ...
                    var g=(new b(c)).rules,c=d.attributes,h=g.width,g=g.height;
...
CKEDITOR.editor.prototype.createFakeElement=function(a,d,g,h){
    var k=this.lang.fakeobjects,k=k[g]||k.unknown,d={
        "class":d,
...
CKEDITOR.editor.prototype.createFakeParserElement=function(a,d,g,h){
    var i=this.lang.fakeobjects,i=i[g]||i.unknown,q;
            ...
            elements:{
                "cke:object":function(d){
                    ...
                    if((!f.classid||!(""+f.classid).toLowerCase())&&!a(d)){
                        for(f=0;f<d.children.length;f++)if(d.children[f].name=="cke:embed"){
...
(function(){
    function a(a){
        ...
        function b(b){
        var f,e=b.config,g=e.floatSpaceDockedOffsetX||0,j=e.floatSpaceDockedOffsetY||0,k=e.floatSpacePinnedOffsetX||0,q=e.floatSpacePinnedOffsetY||0,l=function(c){
            function e(a,b,c){
                m.setStyle(b,d(c));
            ...
            if(o){
                ...
                var u=b.editable(),v=m.getClientRect(),w=u.getClientRect(),x=v.height,y=a("left");
            if(f){
...
var h=CKEDITOR.document.getWindow(),d=CKEDITOR.tools.cssLength
})();
CKEDITOR.plugins.add("listblock",{
    ...
    showAll:function(){
        var a=this._.items,b=this._.groups,c=this.element.getDocument(),f;
        for(f in a)c.getById(a[f]).setStyle("display","");for(var e in b){
            a=c.getById(b[e]);
            f=a.getNext();
            a.setStyle("display","");
...
focus:function(a){
    ...
    if(a){
        for(var b=this.element.getDocument().getById(this._.items[a]).getFirst(),a=this.element.getElementsByTag("a"),
            c,f=-1;c=a.getItem(++f);)if(c.equals(b)){
            this._.focusIndex=f;
            break
        }
        setTimeout(function(){
...
(function(){
    ...
    var a=a+(' onkeydown="return CKEDITOR.tools.callFunction({keydownFn},event,this);" onfocus="return CKEDITOR.tools.callFunction({focusFn},event);" '+
        (CKEDITOR.env.ie?'onclick="return false;" onmouseup':"onclick")+'="CKEDITOR.tools.callFunction({clickFn},this);return false;"><span id="{id}_text" class="cke_combo_text cke_combo_inlinelabel">{label}</span><span class="cke_combo_open"><span class="cke_combo_arrow">'+(CKEDITOR.env.hc?"&#9660;":CKEDITOR.env.air?"&nbsp;":"")+"</span></span></a></span>"),b=CKEDITOR.addTemplate("combo",a);
    ...
    proto:{
        ...
        render:function(a,h){
            function d(){
                ...
                var i=CKEDITOR.env,f="cke_"+this.id,e=CKEDITOR.tools.addFunction(function(b){
                var d=this._;
    ...
    createPanel:function(a){
        if(!this._.panel){
            var b=this._.panelDefinition,d=this._.panelDefinition.block,i=b.parent||CKEDITOR.document.getBody(),f="cke_combopanel__"+this.name,e=new CKEDITOR.ui.floatPanel(a,i,b),g=e.addListBlock(this.id,d),j=this;
            e.onShow=function(){
        ...
        onRender:function(){
            a.on("selectionChange",function(a){
                for(var b=this.getValue(),a=a.data.path.elements,c=0,d;c<a.length;c++){
                    d=a[c];
                    for(var e in q)if(q[e].checkElementMatch(d,true)){
                        e!=b&&this.setValue(e);
                        return
                    }
                    }
...
CKEDITOR.plugins.add("forms",{
    ...
    init:function(a){
        var b=a.lang,c=0,h=function(d,e,g){
            var h={};
...
afterInit:function(a){
    var b=a.dataProcessor,c=b&&b.htmlFilter,b=b&&b.dataFilter;
...
(function(){
    function a(a,b){
        if(!b)var d=a.getSelection(),b=d.getType()==CKEDITOR.SELECTION_ELEMENT&&d.getSelectedElement();
...
(function(){
    ...
    c.setStartBefore(a.data.node);
    c.setEndAfter(a.data.node);
    for(var f=new CKEDITOR.dom.walker(c),e;e=f.next();)if(e.type==CKEDITOR.NODE_ELEMENT)if(!e.equals(a.data.node)&&
        e.getDirection()){
        c.setStartAfter(e);
        f=new CKEDITOR.dom.walker(c)
        }else{
        var g=b.config.justifyClasses;
        if(g)if(e.hasClass(g[0])){
            e.removeClass(g[0]);
            e.addClass(g[2])
    ...
    b.prototype={
    exec:function(b){
        var c=b.getSelection(),i=b.config.enterMode;
        if(c){
            for(var f=c.createBookmarks(),e=c.getRanges(true),g=this.cssClassName,j,k,q=b.config.useComputedState,
                ...
                for(j.enlargeBr=i!=CKEDITOR.ENTER_BR;k=j.getNextParagraph(i==CKEDITOR.ENTER_P?"p":"div");){
                    ...
                    var n=g&&(k.$.className=CKEDITOR.tools.ltrim(k.$.className.replace(this.cssClassRegex,""))),o=this.state==CKEDITOR.TRISTATE_OFF&&(!q||a(k,true)!=this.value);
...
CKEDITOR.plugins.add("justify",{
    init:function(a){
        if(!a.blockless){
            var d=new b(a,"justifyleft","left"),i=new b(a,"justifycenter","center"),f=new b(a,"justifyright","right"),e=new b(a,"justifyblock","justify");
...
CKEDITOR.plugins.add("link",{
    ...
    onLoad:function(){
        function a(a){
            ...
            var b="background:url("+CKEDITOR.getUrl(this.path+"images/anchor.gif")+") no-repeat %1 center;border:1px dotted #00f;",c=".%2 a.cke_anchor,.%2 a.cke_anchor_empty"+(CKEDITOR.env.ie&&CKEDITOR.env.version<7?"":",.cke_editable.%2 a[name],.cke_editable.%2 a[data-cke-saved-name]")+"{"+b+"padding-%1:18px;cursor:auto;}"+(CKEDITOR.env.ie?"a.cke_anchor_empty{display:inline-block;}":"")+".%2 img.cke_anchor{"+
...
afterInit:function(a){
    var b=a.dataProcessor,c=b&&b.dataFilter,b=b&&b.htmlFilter,h=a._.elementsPath&&a._.elementsPath.filters;
    c&&c.addRules({
        elements:{
            a:function(b){
                var c=b.attributes;
                ...
                if(CKEDITOR.plugins.link.synAnchorSelector){
                    var b=f?"cke_anchor_empty":"cke_anchor",e=c["class"];
...
CKEDITOR.removeAnchorCommand.prototype={
    exec:function(a){
        var b=a.getSelection(),c=b.createBookmarks(),h;
        if(b&&(h=b.getSelectedElement())&&(CKEDITOR.plugins.link.fakeAnchor&&!h.getChildCount()?CKEDITOR.plugins.link.tryRestoreFakeAnchor(a,
            h):h.is("a")))h.remove(1);
        else if(h=CKEDITOR.plugins.link.getSelectedLink(a))if(h.hasAttribute("href")){
            h.removeAttributes({
                name:1,
...
(function(){
    function a(a,b,c,d,f){
        ...
        var c=a.doc,d=a.line.wrap,f=a.mouse,e=new CKEDITOR.dom.element(c.$.elementFromPoint(f.x,f.y));
        if(b&&g(a,e)){
            d.hide();
    ...
    function f(a){
    var b=a.doc,c=O('<span contenteditable="false" style="'+K+"position:absolute;border-top:1px dashed "+a.boxColor+'"></span>',b);
    C(c,{
        attach:function(){
        ...
        place:function(){
            var b=
            a.view,c=a.editable,d=a.trigger,f=d.upper,e=d.lower,g=f||e,h=g.getParent(),j={};
            ...
            if(d.is(J)||j.top>b.scroll.y-15&&j.top<b.scroll.y+5){
                ...
                i(a)&&j.top--;
            for(var k in j)j[k]=CKEDITOR.tools.cssLength(j[k]);this.setStyles(j)
            },
        look:function(a){
            if(this.oldLook!=a){
...
function e(a,b){
    var c=new P("p",a.doc),d=new CKEDITOR.dom.range(a.doc),f=a.doc.createText(E),e=a.editor;
    e.fire("saveSnapshot");
    b(c);
    f.appendTo(c);
    ...
    r(f,e);
    var g=Math.min(f.triggerOffset,0|e.size.outerHeight/2),h=e,i=e;
    ...
    if(d&&c.contains(d))for(;!d.getParent().equals(c);)d=
        d.getParent();else d=c.getFirst();
    if(f&&c.contains(f))for(;!f.getParent().equals(c);)f=f.getParent();else f=c.getLast();
    if(!d||!f)return null;
    if(!j(d)||g(a,d))if(!(d=d.getNext(a.isRelevant)))return null;
    r(a,d);
    var c=Number.MAX_VALUE,i,k,m,p;
    ...
    function p(a){
    var b=a.trigger,c=b.upper,
    d=b.lower;
    if(!k(d)&&!k(c))if(b.is(y)){
...
function r(a,b,c){
    ...
    if(b||!(c&&c.date>new Date-G)){
        var d=
        a.win,c=d.getScrollPosition(),d=d.getViewPaneSize();
        C(a.view,{
            scroll:{
                x:c.x,
                y:c.y,
...
function v(b,c,d,f){
    ...
    init:function(e){
        var h=e.config,n=h.magicline_triggerOffset||30,l={
            editor:e,
            triggerOffset:n,
    ...
    e.on("contentDom",function(){
        var h=e.editable(),k=e.document,n=e.window;
        C(l,{
            editable:h,
            doc:k,
            win:n
        ...
        h.attachListener(k,"mouseout",function(a){
            if(e.mode=="wysiwyg"){
                ...
                if(i(l)){
                    ...
                    t(l,
                        true);
                    var c=l.view.editable,d=l.view.scroll;
    ...
    if(!(e.mode!="wysiwyg"||A)){
        ...
        A=setTimeout(function(){
            ...
            if(D&&!l.hiddenMode&&e.focusManager.hasFocus&&!l.line.mouseNear()&&(l.element=b(l,true))){
                ...
                var f=f.getLast(l.isRelevant),g=l.mouse,h=l.view,j=l.triggerOffset;
                if(!c||!f)c=null;
                else{
                    r(l,c);
                    r(l,f);
...
var w=128,x=64,y=32,z=16,D=8,J=4,B=2,F=1,E=" ",A=CKEDITOR.dtd.$listItem,G=100,K="width:0px;height:0px;padding:0px;margin:0px;display:block;z-index:9999;color:#fff;position:absolute;font-size: 0px;line-height:0px;",
L=K+"border-color:transparent;display:block;border-style:solid;",I="<span>"+E+"</span>",C=CKEDITOR.tools.extend,P=CKEDITOR.dom.element,O=P.createFromHtml,H=CKEDITOR.env;
a.prototype={
    set:function(a,b,c){
...
var M=CKEDITOR.dom.walker.whitespaces(),Q=CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT,true),N=["top","left","right","bottom"]
})();
(function(){
    function a(a){
...
function i(a){
    ...
    init:function(a){
        function b(){
            ...
            var g=a.lang,j=CKEDITOR.document,k=j.getWindow(),q,l,n,o,m=CKEDITOR.TRISTATE_OFF;
            a.addCommand("maximize",{
                ...
                editorFocus:false,
                exec:function(){
                    var p=a.container.getChild(1),s=a.ui.space("contents");
                    if(a.mode=="wysiwyg"){
...
afterInit:function(a){
    var b=a.lang.pagebreak.alt,c=a.dataProcessor,
    a=c&&c.dataFilter;
...
a&&a.addRules({
    elements:{
        div:function(a){
            var c=a.attributes,i=c&&c.style,f=i&&a.children.length==1&&a.children[0];
...
CKEDITOR.plugins.pagebreakCmd={
    exec:function(a){
        var b=a.lang.pagebreak.alt,b=CKEDITOR.dom.element.createFromHtml('<div style="page-break-after: always;"contenteditable="false" title="'+b+'" aria-label="'+b+'" data-cke-display-name="pagebreak" class="cke_pagebreak"></div>',
            a.document);
        a.insertElement(b)
        },
    context:"div"
...
(function(){
    function a(a,b){
        ...
        c.on("paste",function(b){
            var f=b.data,e=f.dataValue;
            if(e&&(h||/(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(e))){var g=a(d,function(){if(g)c.fire("paste",
                f);
...
(function(){
    var a,b={
        ...
        readOnly:1,
        exec:function(b){
            var h=b.config,d=h.baseHref?'<base href="'+h.baseHref+'"/>':"",i=CKEDITOR.env.isCustomDomain();
            if(h.fullPage)b=
                b.getData().replace(/<head>/,"$&"+d).replace(/[^>]*(?=<\/title>)/,"$& &mdash; "+b.lang.preview.preview);
            else{
                var h="<body ",f=b.document&&b.document.getBody();
                if(f){
            ...
            f=80;
            try{
                var e=window.screen,d=Math.round(e.width*0.8),h=Math.round(e.height*0.7),f=Math.round(e.width*0.1)
                }catch(g){}
            e="";
            if(i){
        ...
        removeformat:{
            exec:function(a){
                for(var b=a._.removeFormatRegex||(a._.removeFormatRegex=RegExp("^(?:"+a.config.removeFormatTags.replace(/,/g,"|")+")$","i")),c=a._.removeAttributes||(a._.removeAttributes=a.config.removeFormatAttributes.split(",")),h=CKEDITOR.plugins.removeformat.filter,d=a.getSelection().getRanges(1),
                    ...
                    var e=f.createBookmark(),g=e.startNode,j=e.endNode,k=function(c){
                ...
                k(g);
                    ...
                    for(g=g.getNextSourceNode(true,CKEDITOR.NODE_ELEMENT);g;){
                        ...
                        if(!(g.getName()=="img"&&g.data("cke-realelement"))&&
                            h(a,g))if(b.test(g.getName()))g.remove(1);
                            else{
...
filter:function(a,b){
    for(var c=a._.removeFormat.filters,h=0;h<c.length;h++)if(c[h](b)===false)return false;return true
    }
};
...
CKEDITOR.plugins.add("resize",{
    init:function(a){
        var b,c,h,d,i=a.config,f=a.element?a.element.getDirection(1):"ltr";
        ...
        if(i.resize_enabled!==false){
            var e=null,g=(i.resize_dir==
                "both"||i.resize_dir=="horizontal")&&i.resize_minWidth!=i.resize_maxWidth,j=(i.resize_dir=="both"||i.resize_dir=="vertical")&&i.resize_minHeight!=i.resize_maxHeight,k=function(e){
                var k=b,m=c,p=k+(e.data.$.screenX-h)*(f=="rtl"?-1:1),e=m+(e.data.$.screenY-d);
...
(function(){
    function a(a,b){
        ...
        var a=this,c=function(){
            ...
            if(typeof b=="object")for(var d in b)c[d]=b[d];if(h.getControlId(a))c.id=h.getControlId(a);
...
d.equals=CKEDITOR.tools.override(d.equals,function(a){
    return function(b){
        var c=this.contents,d=b.contents,e=h.getScayt(this.editor);
...
CKEDITOR.plugins.scayt={
    ...
    getUiTabs:function(a){
        var b=[],a=a.config.scayt_uiTabs||"1,1,1",a=a.split(",");
        a[3]="1";
        for(var c=
    ...
    loadEngine:function(a){
        ...
        this.engineLoaded=-1;
        var b=document.location.protocol,b=b.search(/https?:/)!=-1?b:"http:",b=a.config.scayt_srcUrl||b+"//svc.webspellchecker.net/scayt26/loader__base.js",d=h.parseUrl(b).path+"/";
...
var h=CKEDITOR.plugins.scayt,d=function(a,b,c,d,h,i,l){
    a.addCommand(d,h);
    a.addMenuItem(d,{
        label:c,
        command:d,
...
CKEDITOR.plugins.add("scayt",{
    ...
    init:function(c){
        var e=c.dataProcessor&&c.dataProcessor.dataFilter,g={
            elements:{
                span:function(a){
                    var b=
                    a.attributes;
...
e&&e.addRules(g);
    var j={},k={},q=c.addCommand("scaytcheck",i);
...
c.contextMenu&&c.addMenuItems&&c.contextMenu.addListener(function(b,e){
    ...
    var g=h.getScayt(c),i=g.getScaytNode();
    if(!i)return null;
    var q=g.getWord(i);
    if(!q)return null;
    var r=g.getLang(),q=window.scayt.getSuggestion(q,r);
    ...
    var r=false,u=c.config.scayt_maxSuggestions;
    typeof u!="number"&&(u=5);
    !u&&(u=q.length);
    for(var v=c.config.scayt_contextCommands||"all",v=v.split("|"),w=0,x=q.length;w<x;w=w+1){
        var y="scayt_suggestion_"+q[w].replace(" ","_"),z=function(a,b){
            return{
                exec:function(){
                    g.replace(a,b)
                    }
...
CKEDITOR.plugins.add("showborders",{
    ...
    afterInit:function(a){
        var c=a.dataProcessor,a=c&&c.dataFilter,c=c&&
        c.htmlFilter;
        a&&a.addRules({
            elements:{
                table:function(a){
...
CKEDITOR.plugins.add("specialchar",{
    ...
    init:function(a){
        ...
        a.addCommand("specialchar",{
            exec:function(){
                var c=
                a.langCode,c=b.availableLangs[c]?c:"en";
                CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(b.path+"dialogs/lang/"+c+".js"),function(){
...
(function(){
    function a(a,c){
        ...
        init:function(b){
            ...
            var h=b.config,d=b.lang.stylescombo,
        i={},f=[],e;
        ...
        onRender:function(){
            b.on("selectionChange",function(a){
                for(var b=this.getValue(),a=a.data.path.elements,c=0,d=a.length,e;c<d;c++){
                    e=a[c];
                    for(var f in i)if(i[f].checkElementRemovable(e,true)){
                        f!=b&&this.setValue(f);
                        return
                    }
                    }
            ...
            exec:function(b){
                if(b.editable().hasFocus){
                    ...
                    if(e=(new CKEDITOR.dom.elementPath(c.getCommonAncestor(),c.root)).contains({
                        ...
                        var c=b.createRange(),g=CKEDITOR.tools.tryThese(function(){
...
CKEDITOR.dom.element.prototype.focusNext=function(a,b){
    var c=b===void 0?this.getTabIndex():b,h,d,i,f,e,g;
    if(c<=0)for(e=this.getNextSourceNode(a,CKEDITOR.NODE_ELEMENT);e;){
        ...
        }else for(e=this.getDocument().getBody().getFirst();e=e.getNextSourceNode(false,CKEDITOR.NODE_ELEMENT);){
        if(!h)if(!d&&e.equals(this)){
            d=true;
            if(a){
...
CKEDITOR.dom.element.prototype.focusPrevious=function(a,
    ...
    if(g.isVisible()&&!((e=g.getTabIndex())<0))if(c<=0){
        if(h&&e===0){
            i=g;
            break
        }
    ...
    if(b instanceof CKEDITOR.dom.selection){
        for(var d=a(b),e=d[0].getAscendant("table"),f=CKEDITOR.tools.buildTableMap(e),b=d[0].getParent().$.rowIndex,d=d[d.length-1],g=d.getParent().$.rowIndex+d.$.rowSpan-1,d=[],h=b;h<=g;h++){
            for(var i=f[h],j=new CKEDITOR.dom.element(e.$.rows[h]),k=0;k<i.length;k++){
                var l=new CKEDITOR.dom.element(i[k]),q=l.getParent().$.rowIndex;
...
function f(b){
    if(b instanceof CKEDITOR.dom.selection){
        var b=a(b),c=b[0]&&b[0].getAscendant("table"),d;
            a:{
            var g=0;
            d=b.length-1;
            for(var h={},i,j;i=b[g++];)CKEDITOR.dom.element.setMarker(h,i,"delete_cell",true);
            for(g=0;i=b[g++];)if((j=i.getPrevious())&&!j.getCustomData("delete_cell")||(j=i.getNext())&&
...
function e(a,b){
    ...
    var i=CKEDITOR.tools.buildTableMap(f),j=i.length,k=i[0].length,
    l=b.getParent().$.rowIndex,q=g(i,l,b);
    if(c){
        var y;
        try{
        ...
        h=e[c];
        var E=h.getParent(),A=h.getFirst(),G=h.$.colSpan,K=h.$.rowSpan,
        E=E.$.rowIndex,L=g(i,E,h),F=F+G*K,z=Math.max(z,L-q+G);
        y=Math.max(y,E-l+K);
        if(!d){
            G=h;
...
function k(b,c){
    ...
    if(c)return true;
    var d=d[0],e=d.getParent(),f=e.getAscendant("table"),h=CKEDITOR.tools.buildTableMap(f),i=e.$.rowIndex,j=g(h,i,d),k=d.$.rowSpan,l;
    if(k>1){
        l=Math.ceil(k/2);
    ...
    if(d.length>1)return false;
    if(c)return true;
    var d=d[0],e=d.getParent(),f=e.getAscendant("table"),f=CKEDITOR.tools.buildTableMap(f),h=
    g(f,e.$.rowIndex,d),i=d.$.colSpan;
    if(i>1){
        e=Math.ceil(i/2);
        i=Math.floor(i/2)
        }else{
...
g.addCommand("columnDelete",h({
    exec:function(b){
        for(var b=b.getSelection(),b=a(b),c=b[0],d=b[b.length-1],b=c.getAscendant("table"),f=CKEDITOR.tools.buildTableMap(b),g,h,i=[],j=0,k=f.length;j<k;j++)for(var l=0,m=f[j].length;l<m;l++){
            f[j][l]==c.$&&(g=l);
            f[j][l]==d.$&&(h=l)
            }
            for(j=g;j<=h;j++)for(l=0;l<f.length;l++){
            d=f[l];
    ...
    tablecell:{
        ...
        getItems:function(){
            ...
            return{
                ...
                tablecell_split_vertical:k(b,true)?CKEDITOR.TRISTATE_OFF:
                CKEDITOR.TRISTATE_DISABLED,
...
CKEDITOR.loadTemplates=function(a,h){
    for(var d=[],i=0,f=a.length;i<f;i++)if(!b[a[i]]){
        d.push(a[i]);
        b[a[i]]=1
        }
...
CKEDITOR.plugins.add("toolbar",{
    ...
    init:function(b){
        var i,f=function(a,c){
            var h,k=b.lang.dir=="rtl",q=b.config.toolbarGroupCycling,q=q===void 0||q;
            switch(c){
                case 9:case CKEDITOR.SHIFT+9:
                    ...
                    if(h.items.length)for(a=h.items[i?h.items.length-1:0];a&&!a.focus;)(a=
        ...
        b.on("uiSpace",function(e){
            if(e.data.space==b.config.toolbarLocation){
                b.toolbox=
                new c;
                var g=CKEDITOR.tools.getNextId(),h=['<span id="',g,'" class="cke_voice_label">',b.lang.toolbar.toolbars,"</span>",'<span id="'+b.ui.spaceId("toolbox")+'" class="cke_toolbox" role="group" aria-labelledby="',g,'" onmousedown="return false;"'],g=b.config.toolbarStartupExpanded!==false,i,q;
                    ...
                    if(r){
                        if(i){
                            ...
                            for(var u=0;u<t.length;u++){
                                var v,w;
                                if(v=b.ui.create(t[u]))if(v.type==CKEDITOR.UI_SEPARATOR)q=i&&v;
                                    else{
                                    w=v.canGroup!==false;
                                    if(!p){
    ...
    function a(a){
        ...
        init:function(b){
            function c(a){
                ...
                var d=new a(b),h=b.addCommand("undo",{
                exec:function(){
                    if(d.undo()){
                        b.selectionChange();
                        this.fire("afterUndo")
...
b.prototype={
    equals:function(a,b){
        var d=this.contents,h=a.contents;
...
a.prototype={
    type:function(a){
        var a=a&&a.data.getKey(),c=a in h,g=this.lastKeystroke in h,j=c&&a==this.lastKeystroke,k=a in i,q=this.lastKeystroke in i;
        if(!(a in d||this.typing)||!c&&!k&&(g||q)||c&&!j){
            var l=new b(this.editor),n=this.snapshots.length;
            CKEDITOR.tools.setTimeout(function(){
...
(function(){
    function a(a){
        var b=this.editor,d=a.document,f=d.body;
    ...
    if(CKEDITOR.env.ie){
        ...
        b.config.enterMode!=CKEDITOR.ENTER_P&&d.on("selectionchange",function(){
            var a=d.getBody(),c=b.getSelection(),e=c&&c.getRanges()[0];
...
function b(a){
    ...
    function c(a){
    if(!a.readOnly){
        var c=a.window,d=a.document,f=d.getBody(),h=f.getFirst(),i=f.getChildren().count();
        if(!i||i==1&&h.type==CKEDITOR.NODE_ELEMENT&&h.hasAttribute("_moz_editor_bogus_node")){
            b(a);
            var h=CKEDITOR.document,n=h.getDocumentElement(),o=n.$.scrollTop,m=n.$.scrollLeft,p=d.$.createEvent("KeyEvents");
...
function h(){
    ...
    if(CKEDITOR.document.$.documentMode>=8){
        ...
        var b=[],c;
        for(c in CKEDITOR.dtd.$removeEmpty)b.push("html.CSS1Compat "+c+"[contenteditable=false]");a.push(b.join(",")+"{display:inline-block}")
        }else if(CKEDITOR.env.gecko){
    ...
    init:function(a){
        a.addMode("wysiwyg",function(b){
            ...
            h.append(d);
            var l="document.open();"+(i?'document.domain="'+document.domain+'";':"")+"document.close();",l=CKEDITOR.env.air?"javascript:void(0)":CKEDITOR.env.ie?"javascript:void(function(){"+encodeURIComponent(l)+"}())":"",n=CKEDITOR.env.ie||CKEDITOR.env.gecko;
            if(n)d.on("load",c);
            var o=[a.lang.editor,a.name].join(),m=a.lang.common.editorHelp;
            CKEDITOR.env.ie&&(o=o+(", "+m));
            var p=CKEDITOR.tools.getNextId(),s=CKEDITOR.dom.element.createFromHtml('<span id="'+p+'" class="cke_voice_label">'+m+"</span>");
            h.append(s,1);
...
var d=/(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,i=CKEDITOR.env.isCustomDomain(),f=CKEDITOR.tools.createClass({
    $:function(b){
        this.base.apply(this,arguments);
    ...
    proto:{
        setData:function(a,b){
            ...
            if(b)this.setHtml(a);
                ...
                var d=c.config,f=d.fullPage,l=d.docType,n=CKEDITOR.tools.buildStyleHtml(h());
...
getData:function(a){
    ...
    var a=this.editor,b=a.config,c=
    b.fullPage,f=c&&a.docType,h=c&&a.xmlDeclaration,i=this.getDocument(),c=c?i.getDocumentElement().getOuterHtml():i.getBody().getHtml();
...
detach:function(){
    var a=this.editor,b=a.document,
    c=a.window.getFrame();
