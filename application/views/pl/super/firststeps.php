<div class='messagebox ui-corner-all'>
    <div class='header ui-widget-header'><?php echo sprintf($clang->gT("Welcome to %s!"), 'GoWebSurvey'); ?></div>
    <br />
    <p><?php $clang->eT("Some piece-of-cake steps to create your very own first survey (not-project):"); ?></p><br />
    <ol>
