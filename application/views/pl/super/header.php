...
<!-- <div class='maintitle'><img src="<?php echo $baseurl; ?>styles/Final-Logo.png" style="width: 20%" alt="GoWebSurvey" title="GoWebSuravey" /></div> -->
        <div id='wrapper'>
            <div id="content">
                <div class="c1">
                    ...
                    <div class="controls">
                        ...
                        if (Yii::app()->session['plid']) {
                            ...
                            <div style="width:27%;float: left; margin-left: 10%; text-align: center">
                                <img height="50" width="70%" src="<?php echo $baseurl; ?>styles/Final-Logo.png"></img>
                            </div>
