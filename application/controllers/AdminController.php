...
class AdminController extends LSYii_Controller {
    ...
    public function actions() {
        ...
        $aActions['uploader'] = 'application.controllers.uploader';
    ...
    public function getActionClasses() {
        return array(
            ...
            'state' => 'stateaction',
            'city' => 'cityaction',
            'cron' => 'cronaction', //Add By Parth 18-06-2014
            'contact_group' => 'contactgroupaction',
            'company_type' => 'companytypeaction',
