    ...
    <head>
        ...
        <script>
            function setCookie(cname,cvalue,exdays) {
                ...
                //document.cookie = cname+"="+cvalue+"; "+expires+"; path='/'; domain='http://gowebsurveys.com/'";
                //document.cookie = cname+"="+cvalue+"; "+expires+"; path='/'; domain='http://www.gowebsurveys.com/'";
                //document.cookie = cname+"="+cvalue+"; "+expires+"; domain=gowebsurveys.com";
    ...
    function SendMessage($subject, $body, $cid, $sp, $pm) {
        ...
        if (mysql_num_rows($result) <= 0) {
            ...
            while ($row = mysql_fetch_assoc($result)) {
                if ($row['Email'] != "") {
                    $headers = "From: contact@gowebsurveys.com";
